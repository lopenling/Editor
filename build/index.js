...
function ExportButton({ editor, name }) {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime14.jsxDEV)(import_flowbite_react3.Button, { size: "xs", className: "text-slate-500", onClick: () => exportAsDocs(editor), children: name }, void 0, !1, {
...
function constructHTML(text, annotations) {
  annotations.sort((a, b) => a.start !== b.start ? a.start - b.start : b.end - a.end);
  let htmlString = "", lastIndex = 0, openTags = [];
  for (annotations.forEach((annot, idx) => {
    for (; openTags.length > 0 && openTags[openTags.length - 1].end <= annot.start; ) {
      let lastTag = openTags.pop();
      htmlString += text.substring(lastIndex, lastTag.end) + `</${lastTag.tagName.toLowerCase()}>`, lastIndex = lastTag.end;
    }
    lastIndex < annot.start && (htmlString += text.substring(lastIndex, annot.start), lastIndex = annot.start);
    let attributesString = "";
    for (let [key, value] of Object.entries(annot.attributes))
      attributesString += ` ${key}="${value}"`;
    htmlString += `<${annot.tagName.toLowerCase()}${attributesString}>`, openTags.push(annot);
  }); openTags.length > 0; ) {
    let tag = openTags.pop();
    htmlString += text.substring(lastIndex, tag.end) + `</${tag.tagName.toLowerCase()}>`, lastIndex = tag.end;
  }
  return lastIndex < text.length && (htmlString += text.substring(lastIndex)), htmlString;
}
...
function TranslationsRoute() {
  ...
  function save() {
    ...
    let sourceContent = source_editor.getHTML(), translationContent = translation_editor.getHTML(), source = processHTML(sourceContent), translationHTML = processHTML(translationContent), sourceText = source.text, sourceAnnotation = source.annotations, translationText = translationHTML.text, translationAnnotation = translationHTML.annotations;
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime15.jsxDEV)("div", { className: "flex gap-4", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime15.jsxDEV)(import_flowbite_react4.Tooltip, { content: "export as docx", placement: "top", children: /* @__PURE__ */ (0, import_jsx_dev_runtime15.jsxDEV)(
          import_flowbite_react4.Dropdown,
          {
            ...
            size: "xs",
            dismissOnClick: !1,
            renderTrigger: () => /* @__PURE__ */ (0, import_jsx_dev_runtime15.jsxDEV)(import_flowbite_react4.Button, { size: "sm", className: "text-white bg-slate-500", children: /* @__PURE__ */ (0, import_jsx_dev_runtime15.jsxDEV)(import_ai2.AiOutlineExport, {}, void 0, !1, {
              fileName: "app/routes/text_.$textId.page.$pageId.translation.$translationId.tsx",
              lineNumber: 275,
              columnNumber: 19
            }, this) }, void 0, !1, {
...
function formatBytes(bytes, decimals = 2) {
  if (bytes === 0)
    return "0 Bytes";
  let k = 1024, dm = decimals < 0 ? 0 : decimals, sizes = ["Bytes", "KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"], i = Math.floor(Math.log(bytes) / Math.log(k));
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime48.jsxDEV)("footer", { className: "absolute bottom-0 w-full  ", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime48.jsxDEV)("div", { className: "mx-auto w-full ", children: /* @__PURE__ */ (0, import_jsx_dev_runtime48.jsxDEV)("div", { className: " px-4 py-6 dark:bg-gray-700 md:flex md:items-center md:justify-between", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime48.jsxDEV)("div", { className: "mt-4 flex space-x-6 sm:justify-center md:mt-0", children: [
        ...
        {
          logo: import_ai8.AiFillTwitterCircle,
