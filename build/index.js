...
var globalStyle_default = "/build/_assets/globalStyle-WM4C5OLN.css";

// app/styles/tailwind.css
var tailwind_default = "/build/_assets/tailwind-5ODO6WK2.css";
...
var import_node3 = require("@remix-run/node"), import_react16 = require("@remix-run/react"), import_react17 = require("@tiptap/react");
...
// app/features/Editor/tiptap/index.ts
var import_extension_history = __toESM(require("@tiptap/extension-history")), import_extension_list_item = __toESM(require("@tiptap/extension-list-item")), import_extension_ordered_list = __toESM(require("@tiptap/extension-ordered-list"));
...
// app/routes/text_.$textId.page.$pageId.translation.$translationId.tsx
var import_bs = require("react-icons/bs"), import_ai2 = require("react-icons/ai"), import_flowbite_react3 = require("flowbite-react"), import_io2 = require("react-icons/io");
var import_react18 = require("react"), import_react_hot_toast2 = __toESM(require("react-hot-toast"));
...
// app/component/hooks/useLocaleStorage.tsx
var import_react15 = require("react"), useLocalStorage = (key, defaultValue) => {
  ...
  }, [value, key]), [value, setValue];
}, useLocaleStorage_default = useLocalStorage;
...
function TranslationsRoute() {
  let { translation, userText, textId, order, user, line_number } = (0, import_react16.useLoaderData)(), source_editor = useEditorInstance_default(userText.content, !0, !1), translation_editor = useEditorInstance_default(translation.content, !0, !1), [sourceScroll, setSourceScroll] = useLocaleStorage_default("sourceScroll", 0), [translationScroll, setTranslationScroll] = useLocaleStorage_default("translationScroll", 0), sourceRef = (0, import_react18.useRef)(null), translationRef = (0, import_react18.useRef)(null), fetcher = (0, import_react16.useFetcher)();
  (0, import_react18.useEffect)(() => (source_editor && source_editor.on("update", ({ editor }) => {
    let content = editor.getHTML();
    setSourceScroll(editor.view.dom.scrollTop);
    let data = ConvertpToList_default(content);
    editor.commands.setContent(data), sourceRef.current?.scrollTo({ top: sourceScroll });
  }), translation_editor && translation_editor.on("update", ({ editor }) => {
    let content = editor.getHTML();
    setTranslationScroll(editor.view.dom.scrollTop);
    let data = ConvertpToList_default(content);
    editor.commands.setContent(data), setTimeout(() => {
      translationRef.current?.scrollTo({ top: translationScroll });
    }, 100);
  }), () => {
    source_editor?.destroy(), translation_editor?.destroy();
  }), [source_editor, translation_editor]), (0, import_react18.useEffect)(() => {
  ...
  let [prevVisibleIndex, setPrevVisibleIndex] = (0, import_react18.useState)(null), [prevVisibleElement] = (0, import_react18.useState)(null), [currentIndex, setCurrentIndex] = (0, import_react18.useState)(0), currentDiv = (0, import_react18.useRef)(null);
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime15.jsxDEV)(import_jsx_dev_runtime15.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime15.jsxDEV)("div", { className: "flex justify-between max-w-6xl m-auto", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime15.jsxDEV)(import_flowbite_react3.Button, { as: import_react16.Link, to: `/text/${textId}/page/${order}`, className: "text-white bg-slate-500", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime15.jsxDEV)(import_io2.IoMdArrowRoundBack, {}, void 0, !1, {
          fileName: "app/routes/text_.$textId.page.$pageId.translation.$translationId.tsx",
          lineNumber: 208,
          columnNumber: 11
        }, this),
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime15.jsxDEV)(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime15.jsxDEV)(import_react17.EditorContent, { editor: source_editor }, void 0, !1, {
              fileName: "app/routes/text_.$textId.page.$pageId.translation.$translationId.tsx",
              lineNumber: 228,
              columnNumber: 11
            }, this)
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime15.jsxDEV)(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime15.jsxDEV)(import_react17.EditorContent, { editor: translation_editor }, void 0, !1, {
              fileName: "app/routes/text_.$textId.page.$pageId.translation.$translationId.tsx",
              lineNumber: 237,
              columnNumber: 11
            }, this)
...
var import_node4 = require("@remix-run/node"), import_react59 = require("@remix-run/react");

// app/features/Editor/component/EditorContainer.tsx
var import_react21 = require("@remix-run/react"), import_react22 = require("@tiptap/react"), import_react23 = require("react"), import_recoil5 = require("recoil");

// app/component/UI/Pagination.tsx
var import_react19 = require("@remix-run/react"), import_fa4 = require("react-icons/fa"), import_jsx_dev_runtime16 = require("react/jsx-dev-runtime");
function Pagination({ pageCount }) {
  let data = (0, import_react19.useLoaderData)(), textId = data.text.id, order = parseInt(data.order), [searchParams] = (0, import_react19.useSearchParams)(), version = searchParams.get("version"), PreviousLink = `/text/${textId}/page/${order - 1}${version ? "/?version=" + version : ""}`, nextLink = `/text/${textId}/page/${order + 1}${version ? "/?version=" + version : ""}`;
  return /* @__PURE__ */ (0, import_jsx_dev_runtime16.jsxDEV)("div", { className: "flex justify-end gap-3", children: [
    order - 1 > 0 && /* @__PURE__ */ (0, import_jsx_dev_runtime16.jsxDEV)(import_react19.Link, { to: PreviousLink, className: "mr-1 flex items-center gap-2 rounded  p-1", children: [
    ...
    order + 1 <= pageCount && /* @__PURE__ */ (0, import_jsx_dev_runtime16.jsxDEV)(import_react19.Link, { to: nextLink, className: "mr-1 flex items-center gap-2 rounded  p-1", children: [
      "next",
...
var import_react20 = require("react"), import_jsx_dev_runtime17 = require("react/jsx-dev-runtime"), Controls = ({ zoomIn, zoomOut, resetTransform, url }) => ((0, import_react20.useEffect)(() => {
  resetTransform();
...
function EditorContainer({ editor, isSaving, page, saveTextFetcher }) {
  let imageUrl = page.imageUrl, pageCount = page?.text.Page.length, pageId = page.id, { annotations, user, text } = (0, import_react21.useLoaderData)(), [Image2, setImage] = (0, import_recoil5.useRecoilState)(ImageState), isPostAllowed = text.allow_post, [selection, setSelectionRange] = (0, import_recoil5.useRecoilState)(selectedTextOnEditor), [searchParams, setSearchParams] = (0, import_react21.useSearchParams)(), searchString = searchParams.get("s") || "", thread = searchParams.get("thread") || "", saving = saveTextFetcher.state !== "idle";
  ...
  }, [annotations?.length, page.content]), (0, import_react23.useEffect)(() => {
    (!searchString || searchString.length === 0) && editor.commands.setSearchTerm("");
  }, [searchString]), (0, import_react23.useEffect)(() => {
...
var import_react24 = require("@remix-run/react"), import_ai3 = require("react-icons/ai"), import_io3 = require("react-icons/io"), import_jsx_dev_runtime19 = require("react/jsx-dev-runtime");
function TextHeader() {
  let { text } = (0, import_react24.useLoaderData)(), loc = (0, import_react24.useLocation)();
  return /* @__PURE__ */ (0, import_jsx_dev_runtime19.jsxDEV)("div", { className: "bg-gray-50  flex justify-between items-center border-t py-3", style: { height: 60 }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime19.jsxDEV)("div", { className: "flex justify-between items-center lg:px-9 md:px-3 max-w-3xl w-full mx-auto", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime19.jsxDEV)(import_react24.Link, { to: "/", children: /* @__PURE__ */ (0, import_jsx_dev_runtime19.jsxDEV)(import_ai3.AiOutlineClose, { size: 30, color: "gray" }, void 0, !1, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime19.jsxDEV)(import_react24.Link, { to: loc.pathname + "?with=all", children: /* @__PURE__ */ (0, import_jsx_dev_runtime19.jsxDEV)(import_io3.IoIosOptions, { size: 30, color: "gray" }, void 0, !1, {
      fileName: "app/component/Layout/TextHeader.tsx",
      lineNumber: 18,
      columnNumber: 11
    }, this) }, void 0, !1, {
...
var import_react25 = require("@remix-run/react"), import_ai4 = require("react-icons/ai"), import_io4 = require("react-icons/io"), import_jsx_dev_runtime20 = require("react/jsx-dev-runtime");
function MenuHeader() {
  let [searchParams, setSearchParams] = (0, import_react25.useSearchParams)(), header = searchParams.get("with");
  function handleBack() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)("div", { className: "w-full uppercase text-gray-500 h-[60px]  bg-gray-100 flex items-center justify-between px-6 py-4", children: [
    header === "all" ? "Resources" : /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)("button", { type: "button", onClick: handleBack, children: /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)(import_io4.IoIosArrowRoundBack, { size: 30 }, void 0, !1, {
...
function MenuHome() {
  let li_className = "hover:text-gray-500 cursor-pointer", [, setSearchParams] = (0, import_react26.useSearchParams)();
...
var import_jsx_dev_runtime22 = require("react/jsx-dev-runtime"), TableOfContents = ({ editor }) => {
  let [isOpen, setIsOpen] = (0, import_react28.useState)(!1), [isVersionOpen, setIsVersionOpen] = (0, import_react28.useState)(!0), data = (0, import_react27.useLoaderData)(), translation = uselitteraTranlation(), handleDropdownToggle = () => {
    setIsOpen(!isOpen);
  }, handleVersionToggle = () => {
    ...
    data.versions.length > 0 && /* @__PURE__ */ (0, import_jsx_dev_runtime22.jsxDEV)("div", { className: "relative", children: [
      ...
      isVersionOpen && data.versions.map(({ version, count }, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime22.jsxDEV)("div", { className: "mr-3", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime22.jsxDEV)("div", { className: "flex gap-2", children: new Array(count).fill(0).map((_, index2) => {
          let textId = (0, import_react27.useLocation)().pathname.split("/")[2], page = index2 + 1;
          return /* @__PURE__ */ (0, import_jsx_dev_runtime22.jsxDEV)("div", { className: "rounded-sm bg-slate-100 p-1 shadow hover:bg-yellow-200", children: /* @__PURE__ */ (0, import_jsx_dev_runtime22.jsxDEV)(import_react27.Link, { to: `/text/${textId}/page/${page}/?version=${version}`, children: page }, void 0, !1, {
            fileName: "app/component/menu/TableOfContent.tsx",
            lineNumber: 81,
            columnNumber: 27
          }, this) }, index2 + "pages", !1, {
...
var import_react32 = require("@remix-run/react"), import_flowbite_react5 = require("flowbite-react"), import_react33 = require("react"), import_ai5 = require("react-icons/ai");

// app/component/menu/TranslationUploader.tsx
var import_react30 = require("react"), import_react_hot_toast3 = __toESM(require("react-hot-toast"));

// app/component/hooks/useTxtUpload.tsx
var import_react29 = require("react"), import_react_dropzone = require("react-dropzone"), baseStyle = {
  flex: 1,
  display: "flex",
  ...
  let { acceptedFiles, getRootProps, getInputProps, isFocused, isDragAccept, isDragReject } = (0, import_react_dropzone.useDropzone)({
    ...
    maxFiles: 1
  }), [fileContent, setFileContent] = (0, import_react29.useState)(""), style = (0, import_react29.useMemo)(
    () => ({
      ...baseStyle,
...
// app/component/menu/TranslationUploader.tsx
var import_react31 = require("@remix-run/react"), import_flowbite_react4 = require("flowbite-react"), import_jsx_dev_runtime24 = require("react/jsx-dev-runtime");
function TranslationUploader({ fetcher }) {
  let { acceptedFiles, fileContent, getRootProps, getInputProps, setFileContent } = useTxtUpload(), { text, page } = (0, import_react31.useLoaderData)(), [title, setTitle] = (0, import_react30.useState)(""), [language, setLanguage] = (0, import_react30.useState)("english"), handleSubmit = () => {
    if (title === "" || !title)
...
function Translations() {
  let { text, page, translations } = (0, import_react32.useLoaderData)(), [upload, setUpload] = (0, import_react33.useState)(!1), fetcher = (0, import_react32.useFetcher)();
        ...
        return /* @__PURE__ */ (0, import_jsx_dev_runtime25.jsxDEV)(
          "div",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_dev_runtime25.jsxDEV)("div", { className: "w-full flex justify-between", children: [
              /* @__PURE__ */ (0, import_jsx_dev_runtime25.jsxDEV)(import_react32.Link, { to: url, className: "flex-1", children: /* @__PURE__ */ (0, import_jsx_dev_runtime25.jsxDEV)("div", { children: [
...
var import_react34 = require("@remix-run/react"), import_react35 = require("react"), import_Reply = __toESM(require_Reply()), import_jsx_dev_runtime26 = require("react/jsx-dev-runtime");
function Replies({ postId, topicId, isCreator, type, replyCount, setReplyCount }) {
  let [replies, setReplies] = (0, import_react35.useState)([]), postListFetcher = (0, import_react34.useFetcher)();
...
var import_jsx_dev_runtime27 = require("react/jsx-dev-runtime"), ContentEditableDiv = (props) => {
  let editor;
  return typeof document < "u" && (editor = (0, import_react36.useEditor)({
    extensions: [
      import_extension_document.default,
      import_extension_paragraph.default,
      import_extension_text.default,
  ...
  })), /* @__PURE__ */ (0, import_jsx_dev_runtime27.jsxDEV)(import_jsx_dev_runtime27.Fragment, { children: editor ? /* @__PURE__ */ (0, import_jsx_dev_runtime27.jsxDEV)(import_react36.EditorContent, { editor }, void 0, !1, {
...
function ReplyForm({ closeReply, topicId, updateReplyCount }) {
  let postFetcher = (0, import_react37.useFetcher)(), textareaRef = (0, import_react38.useRef)(null), loaderData = (0, import_react37.useLoaderData)(), [audio, setAudio] = (0, import_react38.useState)({ tempUrl: "", blob: null }), [textArea, setTextArea] = (0, import_react38.useState)("");
...
var import_react39 = require("@remix-run/react"), import_react40 = require("react"), import_recoil6 = require("recoil");
var import_uuid2 = require("uuid");
var import_jsx_dev_runtime29 = require("react/jsx-dev-runtime");
function FormWithAudio({ fetcher, type, post, onClose = () => {
}, editor }) {
  let content = post?.content ?? "", audioUrl = post?.audioUrl ?? "", [audio, setAudio] = (0, import_react40.useState)({ tempUrl: audioUrl, blob: null }), [body, setBody] = (0, import_react40.useState)(content), [error, setError] = (0, import_react40.useState)(""), [selection, setSelection] = (0, import_recoil6.useRecoilState)(selectedTextOnEditor), data = (0, import_react39.useLoaderData)(), textName = data.text.name, order = data.order, isFormEmpty = body.length < 5 || body === "<p></p>";
...
var import_react41 = require("react"), hydrating = !0;
function useHydrated() {
  let [hydrated, setHydrated] = (0, import_react41.useState)(() => !hydrating);
...
function Post({ isOptimistic, post, showDivider, editor }) {
  let {
    ...
    audioUrl,
    selection
  } = post, [openReply, setOpenReply] = (0, import_react42.useState)(!1), [showReplies, setShowReplies] = (0, import_react42.useState)(!1), [effect, setEffect] = (0, import_react42.useState)(!1), [ReplyCount, setReplyCount] = (0, import_react42.useState)(replyCount), [edit, setEdit] = (0, import_react42.useState)(!1), { user } = (0, import_react43.useLoaderData)(), [searchParams, setSearchParams] = (0, import_react43.useSearchParams)(), fetcher = (0, import_react43.useFetcher)(), translation = uselitteraTranlation(), isSelected = threadId === searchParams?.get("thread"), likedByMe = user ? likedBy.some((l) => l && l.username === user.username) : !1, handleSelectPost = (0, import_react42.useCallback)(
    (id2) => {
...
var import_react44 = require("react"), import_react_router_dom = require("react-router-dom"), import_recoil7 = require("recoil");
...
function Filter({}) {
  let [filterData, setFilterData] = (0, import_recoil7.useRecoilState)(filterDataState), [openFilter, setOpenFilter] = (0, import_recoil7.useRecoilState)(openFilterState), [userInput, setUserInput] = (0, import_react44.useState)(""), searchUser = (0, import_react_router_dom.useFetcher)(), typeId = (0, import_react44.useId)(), solvedId = (0, import_react44.useId)();
...
var Filter_default = (0, import_react44.memo)(Filter);
...
var import_jsx_dev_runtime33 = require("react/jsx-dev-runtime"), PostForm = ({ editor }) => {
  let { user } = (0, import_react45.useLoaderData)(), createPost3 = (0, import_react45.useFetcher)(), selection = (0, import_recoil9.useRecoilValue)(selectedTextOnEditor), isPosting = createPost3.formData && createPost3.formData.get("body") !== "";
...
function PostSidebar({ editor }) {
  let data = (0, import_react47.useLoaderData)(), [params] = (0, import_react47.useSearchParams)(), selectedId = params.get("thread");
...
var import_react52 = require("@remix-run/react"), import_react53 = require("react");
...
var import_react48 = require("react"), import_react_detect_click_outside = require("react-detect-click-outside"), import_react49 = require("@remix-run/react");
...
var Comment = ({ comment }) => {
  let [openEditMenu, setOpenEditMenu] = (0, import_react48.useState)(!1), [edit, setEdit] = (0, import_react48.useState)(!1), [newContent, setNewContent] = (0, import_react48.useState)(comment.text), [checked, setChecked] = (0, import_react48.useState)(comment.type === "support"), { user } = (0, import_react49.useOutletContext)(), ref = (0, import_react_detect_click_outside.useDetectClickOutside)({
    onTriggered: () => setOpenEditMenu(!1)
  }), color = comment.type === "support" ? "bg-green-100" : comment.type === "reject" ? "bg-red-100" : null, time = timeAgo(comment.createdAt), fetcher = (0, import_react49.useFetcher)(), handleEdit = () => {
    setEdit(!0);
  }, handleDelete = () => {
    confirm("do you want to delete the post") ? fetcher.submit(
      {
...
function useFetcherWithPromise() {
  let resolveRef = (0, import_react50.useRef)(), promiseRef = (0, import_react50.useRef)(), fetcher = (0, import_react51.useFetcher)();
  promiseRef.current || (promiseRef.current = new Promise((resolve) => {
    resolveRef.current = resolve;
  }));
  let resetResolver = (0, import_react50.useCallback)(() => {
    promiseRef.current = new Promise((resolve) => {
      resolveRef.current = resolve;
    });
  }, [promiseRef, resolveRef]), submit = (0, import_react50.useCallback)(
...
function Suggestion2({ editor, suggest, optimistic = !1 }) {
  let likeFetcher = useFetcherWithPromise(), deleteFetcher = (0, import_react52.useFetcher)(), editFetcher = (0, import_react52.useFetcher)(), [effect, setEffect] = (0, import_react53.useState)(!1), [openEdit, setOpenEdit] = (0, import_react53.useState)(!1), [openComment, setOpenComment] = (0, import_react53.useState)(!1), [openEditMenu, setOpenEditMenu] = (0, import_react53.useState)(!1), { text, user } = (0, import_react52.useLoaderData)(), ref = (0, import_react_detect_click_outside2.useDetectClickOutside)({
    onTriggered: () => setOpenEditMenu(!1)
...
function CommentSection({ id, setOpenComment, comments, type }) {
  let [commentText, setCommentText] = (0, import_react53.useState)(""), [audio, setAudio] = (0, import_react53.useState)({ tempUrl: "", blob: null }), data = (0, import_react52.useLoaderData)(), postCommentFetcher = (0, import_react52.useFetcher)();
...
var import_react54 = require("@remix-run/react"), import_jsx_dev_runtime38 = require("react/jsx-dev-runtime");
function Suggestions({ editor }) {
  let { suggestions } = (0, import_react54.useLoaderData)(), groupedSuggestion = transformObjectsByNewValue(suggestions);
...
var import_react55 = require("@remix-run/react"), import_react56 = require("react"), import_uuid4 = require("uuid");
var import_jsx_dev_runtime39 = require("react/jsx-dev-runtime");
function SuggestionForm({ editor }) {
  let { user, page, text } = (0, import_react55.useLoaderData)(), [searchParams, setSearchParams] = (0, import_react55.useSearchParams)(), [suggestionInput, setSuggestionInput] = (0, import_react56.useState)(""), [error, setError] = (0, import_react56.useState)(null), addSuggestion = useFetcherWithPromise(), [audio, setAudio] = (0, import_react56.useState)({ tempUrl: "", blob: null }), handleSuggestionSubmit = async () => {
    if (suggestionInput === "")
...
// app/component/menu/Menu.tsx
var import_react58 = require("react"), import_jsx_dev_runtime42 = require("react/jsx-dev-runtime");
function Menu({ editor }) {
  let [searchParams] = (0, import_react57.useSearchParams)(), menu = searchParams.get("with");
...
function Page() {
  let data = (0, import_react59.useLoaderData)(), { page } = data, saveTextFetcher = (0, import_react59.useFetcher)(), editor = useEditorInstance_default(void 0, !1), withImage = !data.text.allow_post;
...
var import_react62 = require("@remix-run/react"), import_jsx_dev_runtime44 = require("react/jsx-dev-runtime");
function SourceEditor() {
  let { source } = (0, import_react62.useLoaderData)(), content = source.content, editor = useEditorInstance_default(content, !0), saveFetcher = (0, import_react62.useFetcher)();
  return (0, import_react60.useEffect)(() => {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime44.jsxDEV)(import_react61.EditorContent, { editor }, void 0, !1, {
      fileName: "app/features/Translation/SourceEditor.tsx",
      lineNumber: 42,
      columnNumber: 7
    }, this)
...
var import_react65 = require("@remix-run/react"), import_jsx_dev_runtime45 = require("react/jsx-dev-runtime");
function TranslationEditor() {
  let { translation } = (0, import_react65.useLoaderData)(), content = translation?.content, editor = useEditorInstance_default(content, !0), saveFetcher = (0, import_react65.useFetcher)();
  return (0, import_react63.useEffect)(() => {
  ...
  }, [editor]), (0, import_react63.useEffect)(() => {
    let timer = setTimeout(() => {
      let newContent = content.replace(/[\r\n]+/g, "<p/><p>");
      editor?.commands.setContent(newContent);
    }, 100);
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime45.jsxDEV)(import_react64.EditorContent, { editor }, void 0, !1, {
      fileName: "app/features/Translation/TranslationEditor.tsx",
      lineNumber: 42,
      columnNumber: 7
    }, this)
...
var import_react66 = require("@remix-run/react"), import_flowbite_react8 = require("flowbite-react");
...
function Index() {
  let data = (0, import_react67.useLoaderData)(), navigation = (0, import_react67.useNavigation)(), [params] = (0, import_react66.useSearchParams)(), [searchInput, setSearchInput] = (0, import_react68.useState)(""), translation = uselitteraTranlation(), handleInputChange = (event) => {
  ...
  return lists?.message ? /* @__PURE__ */ (0, import_jsx_dev_runtime49.jsxDEV)("div", { className: "text-red-400", children: lists?.message }, void 0, !1, {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime49.jsxDEV)("div", { className: " mx-auto max-w-2xl ", style: { paddingTop: 56 }, children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime49.jsxDEV)("div", { className: "flex w-full flex-col items-center justify-center  px-3 pt-24 md:px-1.5  ", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime49.jsxDEV)(import_react66.Form, { method: "GET", className: "mb-3 w-full max-w-2xl", children: /* @__PURE__ */ (0, import_jsx_dev_runtime49.jsxDEV)("div", { className: "relative flex w-full space-x-3 ", children: [
            ...
            data?.latestTexts && /* @__PURE__ */ (0, import_jsx_dev_runtime49.jsxDEV)(import_jsx_dev_runtime49.Fragment, { children: [
              data.latestTexts.list.map((text) => {
                ...
                return /* @__PURE__ */ (0, import_jsx_dev_runtime49.jsxDEV)("div", { className: "flex w-full justify-between border-b dark:border-gray-700", children: [
                  /* @__PURE__ */ (0, import_jsx_dev_runtime49.jsxDEV)("div", { className: "flex items-center gap-1 px-4 py-4", style: { fontFamily: "monlam" }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime49.jsxDEV)(import_react66.Link, { to: url, children: text.name }, void 0, !1, {
                    fileName: "app/routes/_index.tsx",
                    lineNumber: 117,
                    columnNumber: 23
                  }, this) }, void 0, !1, {
    ...
    (0, import_react67.useLocation)().pathname,
    !0,
    {
      fileName: "app/routes/_index.tsx",
      lineNumber: 80,
          ...
          "tr",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_dev_runtime50.jsxDEV)("th", { scope: "col", className: "flex items-center gap-1 px-4 py-4", style: { fontFamily: "monlam" }, children: [
                ...
                /* @__PURE__ */ (0, import_jsx_dev_runtime50.jsxDEV)(import_react69.Link, { to: url, children: text.name }, void 0, !1, {
                  fileName: "app/routes/list.tsx",
                  lineNumber: 82,
                  columnNumber: 19
                }, this)
