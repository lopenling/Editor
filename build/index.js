...
var import_node4 = require("@remix-run/node"), import_react60 = require("@remix-run/react");
...
var EditorContainer_default = EditorContainer, LoadingIndicator = () => /* @__PURE__ */ (0, import_jsx_dev_runtime21.jsxDEV)("div", { className: "flex h-[400px] w-full animate-pulse justify-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime21.jsxDEV)("div", { className: "mr-2 h-full flex-1 bg-gray-300 dark:bg-gray-700" }, void 0, !1, {
  ...
  lineNumber: 105,
  columnNumber: 3
}, this), Header2 = ({ isSaving, pageCount, user }) => /* @__PURE__ */ (0, import_jsx_dev_runtime21.jsxDEV)("div", { className: "text-light z-10 flex items-center justify-between px-2 py-4", children: [
  /* @__PURE__ */ (0, import_jsx_dev_runtime21.jsxDEV)("div", { className: "flex w-full items-center justify-between gap-2", children: [
...
var Comment = ({ comment }) => {
  let [openEditMenu, setOpenEditMenu] = (0, import_react50.useState)(!1), [edit, setEdit] = (0, import_react50.useState)(!1), [newContent, setNewContent] = (0, import_react50.useState)(comment.text), [checked, setChecked] = (0, import_react50.useState)(comment.type === "support"), { user } = (0, import_react51.useOutletContext)(), ref = (0, import_react_detect_click_outside.useDetectClickOutside)({
    ...
    ) : console.log(...oo_oo9("2130371336_53_6_53_30_4", "cancelled"));
  }, handleSubmit = () => {
    fetcher.submit(
      {
        id: comment.id,
...
// app/features/Suggestion/Suggestion.tsx
var import_flowbite_react13 = require("flowbite-react"), import_jsx_dev_runtime40 = require("react/jsx-dev-runtime");
function Suggestion2({ editor, suggest, optimistic = !1 }) {
  let likeFetcher = useFetcherWithPromise(), deleteFetcher = (0, import_react54.useFetcher)(), editFetcher = (0, import_react54.useFetcher)(), [effect, setEffect] = useState(!1), [openEdit, setOpenEdit] = useState(!1), [openComment, setOpenComment] = useState(!1), [openEditMenu, setOpenEditMenu] = useState(!1), { text, user } = (0, import_react54.useLoaderData)(), ref = (0, import_react_detect_click_outside2.useDetectClickOutside)({
    onTriggered: () => setOpenEditMenu(!1)
  ...
  function deleteSuggestion2(id) {
    ...
    ) : console.log(...oo_oo10("2484206343_73_6_73_30_4", "cancelled"));
  }
...
function CommentSection({ id, setOpenComment, comments, type }) {
  let [commentText, setCommentText] = useState(""), [audio, setAudio] = useState({ tempUrl: "", blob: null }), data = (0, import_react54.useLoaderData)(), postCommentFetcher = (0, import_react54.useFetcher)();
...
var import_react55 = require("@remix-run/react"), import_jsx_dev_runtime41 = require("react/jsx-dev-runtime");
function Suggestions({ editor }) {
  let { suggestions } = (0, import_react55.useLoaderData)(), groupedSuggestion = transformObjectsByNewValue(suggestions);
...
var import_react56 = require("@remix-run/react"), import_react57 = require("react"), import_uuid4 = require("uuid");
...
function SuggestionForm({ editor }) {
  let { user, page, text } = (0, import_react56.useLoaderData)(), [searchParams, setSearchParams] = (0, import_react56.useSearchParams)(), [suggestionInput, setSuggestionInput] = (0, import_react57.useState)(""), [error, setError] = (0, import_react57.useState)(null), addSuggestion = useFetcherWithPromise(), [audio, setAudio] = (0, import_react57.useState)({ tempUrl: "", blob: null }), handleSuggestionSubmit = async () => {
    if (suggestionInput === "")
...
// app/component/menu/Menu.tsx
var import_react59 = require("react"), import_jsx_dev_runtime45 = require("react/jsx-dev-runtime");
function Menu({ editor }) {
  let [searchParams] = (0, import_react58.useSearchParams)(), menu = searchParams.get("with");
...
function Page() {
  let data = (0, import_react60.useLoaderData)(), { text, page } = data, saveTextFetcher = (0, import_react60.useFetcher)(), editor = useEditorInstance_default({ name: "text" + text.id + "page" + page.id, content: void 0, isEditable: !1 }), withImage = !data.text.allow_post;
...
var import_react61 = require("@remix-run/react"), import_flowbite_react15 = require("flowbite-react");
...
function Index() {
  let data = (0, import_react62.useLoaderData)(), navigation = (0, import_react62.useNavigation)(), [params, setSearchParams] = (0, import_react61.useSearchParams)(), [searchInput, setSearchInput] = (0, import_react63.useState)(params.get("search") ?? ""), translation = uselitteraTranlation();
...
function MainLayout({ children }) {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime49.jsxDEV)(
    ...
    (0, import_react62.useLocation)().pathname,
    !0,
    {
      fileName: "app/routes/_index.tsx",
      lineNumber: 78,
...
function SearchBar({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime49.jsxDEV)("div", { className: "mx-auto max-w-2xl", style: { paddingTop: 56 + 40 }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime49.jsxDEV)(import_react61.Form, { method: "GET", className: "mb-3 w-full max-w-2xl", children: /* @__PURE__ */ (0, import_jsx_dev_runtime49.jsxDEV)("div", { className: "relative flex w-full space-x-3", children: [
...
function ContentArea({ latestTexts, isLoading }) {
  let { textList } = (0, import_react62.useLoaderData)();
  return /* @__PURE__ */ (0, import_jsx_dev_runtime49.jsxDEV)("div", { className: "flex w-full mx-auto max-w-2xl flex-col items-center justify-start py-10", children: [
    ...
    !isLoading && /* @__PURE__ */ (0, import_jsx_dev_runtime49.jsxDEV)(import_react63.Suspense, { fallback: /* @__PURE__ */ (0, import_jsx_dev_runtime49.jsxDEV)("div", { children: "loading..." }, void 0, !1, {
      fileName: "app/routes/_index.tsx",
      lineNumber: 137,
      columnNumber: 29
    }, this), children: /* @__PURE__ */ (0, import_jsx_dev_runtime49.jsxDEV)(import_react61.Await, { resolve: textList, children: (lists) => lists ? lists?.length === 0 ? /* @__PURE__ */ (0, import_jsx_dev_runtime49.jsxDEV)(NoResultMessage, {}, void 0, !1, {
      fileName: "app/routes/_index.tsx",
      lineNumber: 141,
      columnNumber: 47
...
function TextLink({ url, name }) {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime49.jsxDEV)("div", { className: "flex items-center gap-1 px-4 py-4", style: { fontFamily: "monlam" }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime49.jsxDEV)(import_react61.Link, { to: url, children: name }, void 0, !1, {
    fileName: "app/routes/_index.tsx",
    lineNumber: 166,
    columnNumber: 7
  }, this) }, void 0, !1, {
          ...
          "tr",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_dev_runtime50.jsxDEV)("th", { scope: "col", className: "flex items-center gap-1 px-4 py-4", style: { fontFamily: "monlam" }, children: [
                ...
                /* @__PURE__ */ (0, import_jsx_dev_runtime50.jsxDEV)(import_react64.Link, { to: url, children: text.name }, void 0, !1, {
                  fileName: "app/routes/list.tsx",
                  lineNumber: 82,
                  columnNumber: 19
                }, this)
