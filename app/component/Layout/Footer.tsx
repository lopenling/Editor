...
export default function FooterContainer() {
  return (
    <>
      {' '}
      <div className=" flex h-48 items-center justify-center text-3xl font-extrabold capitalize">our partners</div>
      <div className="flex h-[350px] w-full flex-col items-center justify-center bg-green-700">
        <img src={indrajalaLogo} alt={'indrajala'} className="max-h-[136px] max-w-[387px]" />
      </div>
