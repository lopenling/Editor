    ...
    >
      ...
      <div className=" relative sm:w-full lg:w-1/3">
        <div className="hidden w-full items-center justify-end md:inline-flex gap-2">
          <div className="relative sortDiv">
            <button className="flex items-center justify-center space-x-2 rounded-lg border border-gray-200 px-3 py-2 mb-3">
              <svg
                width="16"
                height="14"
                viewBox="0 0 16 14"
            ...
            <div className="popup shadow-lg shadow-slate-500 hidden flex-col gap-2 p-2 w-full absolute top-full z-10">
              <button
                className={!isLatestPost ? "bg-green-300" : "bg-transparent"}
