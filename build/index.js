...
async function getPageWithId(id) {
  try {
    ...
    console.log(...oo_oo7("9f124d64_0", e));
  }
}
async function getPage(textId, order) {
  try {
    ...
    console.log(...oo_oo7("9f124d64_1", e));
  }
}
