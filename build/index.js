...
var DiscourseApi = class {
  ...
  async fetchCategoryList(id) {
    ...
    )).json(), filterCategory = categories == null ? void 0 : categories.category_list.categories.find(
  ...
  async addCategory(categoryName, parent_category_id) {
    ...
    try {
      let category = await (await fetch(
  ...
  async addTopic(threadId, username, category_id, topic_name, bodyContent, textId, audioUrl) {
    let auth_headers = this.authHeader(), url = `${this.origin}/text/${textId}/posts?thread=${threadId}`, bodyContentWithLink = addLinktoQuestion(bodyContent, url), post_text = `
...
`;
    ...
    let new_Topic_data = {
      ...
      raw: post_text
    }, queryParams = new URLSearchParams(new_Topic_data).toString(), data = await (await fetch(
...
async function createThread(userName, textTitle, blockquoteArea, postContent, parentCategoryId, textId, audioUrl, threadId) {
  ...
  return category ? categoryId = category.id : categoryId = (await api.addCategory(
    textTitle,
    parseInt(parentCategoryId)
  )).category.id, await api.addTopic(
    threadId,
    userName,
    categoryId,
    blockquoteArea,
...
var import_remix_utils = require("remix-utils"), import_jsx_runtime3 = require("react/jsx-runtime"), Button = ({ label = "", ...props }) => {
  let color = props.type === "submit" ? "bg-green-400" : "bg-gray-300", disabled = props.disabled === null ? !1 : props.disabled, textColor = props.type === "submit" ? "text-white" : "text-black";
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_remix_utils.ClientOnly, { fallback: "<button/>", children: () => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
    "button",
    {
...
function GlobalLoading() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    "div",
    {
      ...
      "aria-hidden": !active,
      className: `
         pointer-events-none fixed left-0 bottom-0 z-50 p-4 transition-all duration-500 ease-out ${active ? "translate-y-0" : "translate-y-full"}`,
...
function Loader() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "bg-gray-200 rounded-full w-64", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
    "div",
    {
...
function LogInMessage() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
    "div",
    {
      ...
      role: "alert",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-orange-500 bg-orange-100 rounded-lg dark:bg-orange-700 dark:text-orange-200", children: [
...
function ProgressBar() {
  let [scrollPercentage, setScrollPercentage] = (0, import_react5.useState)(0), handleScroll = () => {
    let container = document == null ? void 0 : document.getElementById("textEditorContainer");
    if (container) {
      let fullHeight = container.scrollHeight - window.innerHeight, progress = (container.scrollTop + container.clientHeight - window.innerHeight + 60) / fullHeight * 100;
      setScrollPercentage(() => Math.floor(progress));
    }
  };
  return (0, import_react5.useEffect)(() => {
    let container = document == null ? void 0 : document.getElementById("textEditorContainer");
    return container && container.addEventListener("scroll", handleScroll), () => {
      container && container.removeEventListener("scroll", handleScroll);
    };
  }, []), /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "w-full rounded-full h-1.5  ", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
    "div",
    {
...
var import_flowbite_react = require("flowbite-react"), import_jsx_runtime8 = require("react/jsx-runtime");
function Skeleton({ height, number }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
    "div",
    {
      ...
      children: [
        items.map((l, index) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
...
var import_react6 = require("react"), import_jsx_runtime9 = require("react/jsx-runtime"), TextArea = (props, ref) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
  "textarea",
  {
    ref,
    ...props,
...
var import_react7 = require("react"), import_react_notifications_component = require("react-notifications-component"), import_jsx_runtime10 = require("react/jsx-runtime"), OnlineUsers = ({ onlineMembers, count }) => count < 1 ? null : /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(import_jsx_runtime10.Fragment, { children: [
  /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_react_notifications_component.ReactNotifications, {}),
  /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "fixed bottom-2 right-2 p-2 z-50 bg-green-200 rounded", children: onlineMembers && /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "flex gap-2", children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { children: [
      " online: ",
      count
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "flex -space-x-4", children: onlineMembers.map(([id, info]) => /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
      "img",
      {
        title: info.username,
...
function ErrorBoundary() {
  ...
  return (0, import_react8.isRouteErrorResponse)(error) ? /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { children: [
...
function App() {
  var _a, _b, _c;
  let data = (0, import_react8.useLoaderData)(), navigation = (0, import_react8.useNavigation)(), routeChanged = navigation.state === "loading" && ((_a = navigation.location) == null ? void 0 : _a.pathname.includes("/text"));
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("html", { className: ((_c = (_b = data.user) == null ? void 0 : _b.preference) == null ? void 0 : _c.theme) || "light", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("body", { className: "relative dark:bg-gray-600 dark:text-white  scrollbar-thin scrollbar-thumb-gray-900 scrollbar-track-gray-100", children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(import_react_littera2.LitteraProvider, { locales: ["en_US", "bo_TI"], children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(import_framer_motion.AnimatePresence, { mode: "wait", initial: !1, children: routeChanged ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
        "div",
        {
          style: { height: "100vh" },
      ...
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(import_react8.ScrollRestoration, { getKey: (location) => location.pathname }),
...
var action = async ({ request }) => {
  let user = await getUserSession(request), theme2 = (await request.formData()).get("theme");
...
var import_node3 = require("@remix-run/node"), AWS = __toESM(require("aws-sdk")), import_stream = require("stream"), AWS_ACCESS_KEY_ID = process.env.AWS_ACCESS_KEY_ID_PRODUCTION, AWS_SECRET_ACCESS_KEY = process.env.AWS_SECRET_ACCESS_KEY_PRODUCTION, BUCKET_NAME = process.env.BUCKET_NAME_PRODUCTION ?? "", uploadStream = ({ Key }) => {
  let s3 = new AWS.S3({
...
async function uploadStreamToS3(data, filename) {
  ...
  return await (0, import_node3.writeAsyncIterableToWritable)(data, stream.writeStream), (await stream.promise).Location;
}
...
// app/routes/api.suggestion.comment.tsx
var import_node4 = require("@remix-run/node"), action2 = async ({ request }) => {
  let user = await getUserSession(request), uploadHandler = (0, import_node4.unstable_composeUploadHandlers)(
    uploadAudio,
    (0, import_node4.unstable_createMemoryUploadHandler)()
  ), formData = await (0, import_node4.unstable_parseMultipartFormData)(request, uploadHandler), Obj = Object.fromEntries(formData);
  if (request.method === "POST") {
    let comment = Obj.commentContent, id = Obj.id, audioUrl = Obj.file, type = Obj.type;
    return await createCommentOnSuggestion(
      comment,
      id,
      user.id,
      audioUrl,
  ...
  if (request.method === "PATCH") {
    ...
    return await updateCommentOnSuggestion(
      parseInt(id),
      newContent,
      type
    );
...
var fullSearch = (textList, search_term) => {
  ...
  for (let text of textList) {
    let id = text.id, content_length = text.content.length, content = text.content.replace(
      /<br\s*\/?\s*(class\s*=\s*['"]\S*['"])?\s*>/gi,
      `
`
    ).replace(/(<([^>]+)>)/gi, ""), contentMatch = Array.from(
      content.matchAll(new RegExp(search_term, "g"))
    );
    if (Array.from(
      text.name.matchAll(new RegExp(search_term, "g"))
    ).length > 0 || contentMatch.length > 0) {
      let result = {
        id: text.id,
        name: text.name,
        results: [],
      ...
      for (let m of contentMatch) {
        if (max_results === 0 || max_results > 0 && result.total < max_results) {
          ...
          let extract = content.substring(start, end), delimiterMatches = Array.from(
...
function useFetcherWithPromise() {
  let resolveRef = (0, import_react9.useRef)(), promiseRef = (0, import_react9.useRef)();
...
async function updateSuggestionContent(id, newValue) {
  try {
    return console.log(...oo_oo4("13851277_0", id)), await db.suggestion.update({
      where: {
        id
      },
      data: {
...
var action3 = async ({ request }) => {
  ...
  try {
    ...
    if (update) {
      ...
      return highestLiked != null && highestLiked.textId && await trigetPusherUpdate_server_default(user, highestLiked.textId), {
        highestLiked,
        likedBy: update
      };
    }
...
var loader2 = async ({ request }) => {
  ...
  let fetchData = (await getAllUser()).filter(
    (user) => user == null ? void 0 : user.username.toLowerCase().includes(userName.toLowerCase())
  );
...
var import_node5 = require("@remix-run/node"), loader3 = async ({ request }) => {
  ...
  if (request.method === "POST") {
    ...
    ), formData = await (0, import_node5.unstable_parseMultipartFormData)(request, uploadHandler), Obj = Object.fromEntries(formData), oldValue = Obj.oldValue, textId = Obj.textId, newValue = Obj.newValue, userId = Obj.userId, threadId = Obj.threadId, filepath = Obj.file;
    try {
...
var import_react14 = require("@remix-run/react"), import_Post = __toESM(require_Post());

// app/states.ts
var import_recoil2 = require("recoil"), theme = (0, import_recoil2.atom)({
  key: "theme-tailwind",
  default: !1
...
function FormWithAudio({
  ...
  var _a, _b;
  let content = (post == null ? void 0 : post.content) ?? "", audioUrl = (post == null ? void 0 : post.audioUrl) ?? "", [audio, setAudio] = (0, import_react13.useState)({ tempUrl: audioUrl, blob: null }), [body, setBody] = (0, import_react13.useState)(content), [error, setError] = (0, import_react13.useState)(""), [selection, setSelection] = (0, import_recoil3.useRecoilState)(selectedTextOnEditor), data = (0, import_react12.useOutletContext)(), isFormEmpty = body.length < 5, { editor } = (0, import_react12.useOutletContext)();
  ...
  async function handleSubmit(e) {
    ...
    let id = null;
    editor.isActive("post") ? id = (_a2 = editor.getAttributes("post")) == null ? void 0 : _a2.id : id = (0, import_uuid.v4)();
    let item = {
      threadId: id,
    ...
    if (blob ? form_data.append("file", blob, `text-${(_d = data == null ? void 0 : data.text) == null ? void 0 : _d.id}-${(0, import_uuid.v4)()}.wav`) : form_data.append("audioUrl", audio.tempUrl), type === "update") {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(fetcher.Form, { className: "flex flex-col gap-3", children: [
    ...
    audio.tempUrl !== "" ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_jsx_runtime12.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "w-full flex items-center gap-3 ", children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_AudioPlayer.default, { src: audio.tempUrl }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { onClick: () => setAudio({ tempUrl: "", blob: null }), children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
        "svg",
        {
          width: "20",
          height: "20",
    ...
    error && error !== "" && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "font-sm text-red-500", children: error }),
    ((_a = fetcher.data) == null ? void 0 : _a.message) && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "font-sm text-red-500", children: (_b = fetcher.data) == null ? void 0 : _b.message }),
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "flex justify-between items-center", children: [
      audio.tempUrl === "" ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_AudioRecorder.default, { setAudio }) : /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", {}),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "flex justify-end gap-2", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(Button, { onClick: handleSubmit, type: "submit", label: "post" })
      ] })
    ] })
  ] });
}
...
// app/features/Post/PostForm.tsx
var import_jsx_runtime13 = require("react/jsx-runtime"), PostForm = () => {
  var _a, _b;
  let createPost3 = useFetcherPromise_default(), { user } = (0, import_react14.useOutletContext)(), [selection, setSelection] = (0, import_recoil4.useRecoilState)(selectedTextOnEditor);
  return createPost3.formData && createPost3.formData.get("body") !== "" ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
    import_Post.default,
    {
      post: {
        audioUrl: "",
  ...
  ) : selection.type === "" ? null : /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("section", { className: " shadow rounded p-3 mb-3", children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "flex items-start justify-between", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "text-base font-medium leading-tight text-gray-900 dark:text-gray-300 mb-3 capitalize", children: selection.type === "question" ? "ask question" : "new comment" }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "font-bold text-gray-400 text-sm", children: 0 })
    ] }),
    user ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { "aria-label": "Default tabs ", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(FormWithAudio, { fetcher: createPost3, type: "post", post: null }) }) : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(LogInMessage, {})
  ] });
...
var import_react16 = require("react"), import_Post2 = __toESM(require_Post()), import_recoil6 = require("recoil");

// app/features/Post/Filter.tsx
var import_react15 = require("react"), import_react_router_dom = require("react-router-dom"), import_recoil5 = require("recoil");
var import_react_tailwindcss_datepicker = __toESM(require("react-tailwindcss-datepicker")), import_flowbite_react2 = require("flowbite-react");
var import_jsx_runtime14 = require("react/jsx-runtime");
function Filter({}) {
  var _a, _b, _c, _d;
  let [filterData, setFilterData] = (0, import_recoil5.useRecoilState)(filterDataState), [openFilter, setOpenFilter] = (0, import_recoil5.useRecoilState)(openFilterState), [userInput, setUserInput] = (0, import_react15.useState)(""), searchUser = (0, import_react_router_dom.useFetcher)(), typeId = (0, import_react15.useId)(), solvedId = (0, import_react15.useId)();
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(
    import_flowbite_react2.Modal,
    {
      ...
      size: "md",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(import_flowbite_react2.Modal.Header, { children: translation.filter }),
        /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "p-5", children: [
          /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "flex flex-col items-start justify-start space-y-4", children: [
            /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "flex flex-col items-start justify-start space-y-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("p", { className: "text-sm font-semibold leading-tight", children: "Type" }),
              /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "flex flex-col items-start justify-start space-y-0.5", children: [
                { value: "all", label: "All" },
                { value: "comment", label: "Comments only" },
                { value: "question", label: "Questions only" }
              ].map(({ value, label }) => /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "flex py-2", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "flex w-full flex-col items-start justify-start space-y-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("p", { className: "text-sm font-semibold leading-tight ", children: "Date" }),
              /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
                import_react_tailwindcss_datepicker.default,
                {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "flex w-full flex-col items-start justify-start space-y-2.5", children: [
              /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("p", { className: "text-sm font-semibold leading-tight ", children: "Users" }),
              (_a = filterData.user) == null ? void 0 : _a.map((user) => /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(
                "div",
                {
                  className: "flex items-center justify-center space-x-1 rounded bg-gray-100 px-1.5 py-0.5",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("p", { className: "text-center text-xs font-medium leading-none text-gray-600", children: user }),
                    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
                      "svg",
                      {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "flex w-full flex-col items-start justify-start space-y-2 rounded-lg px-0.5 pb-1", children: [
                /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "inline-flex w-full items-center justify-start rounded-lg border border-blue-600 bg-gray-50 px-4 py-1", children: /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "flex h-full flex-1 items-center justify-start space-x-2", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
                    "svg",
                    {
                      width: "18",
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(
                    searchUser.Form,
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("button", { type: "button", onClick: () => setUserInput(""), children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
                          "svg",
                          {
                            width: "18",
                            height: "18",
                ...
                ((_b = searchUser.data) == null ? void 0 : _b.length) > 0 && userInput !== "" && !isFetchingUser && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "flex w-full flex-col items-center justify-start space-y-3 rounded-lg border border-gray-200  p-4 shadow", children: (_c = searchUser.data) == null ? void 0 : _c.map((user) => /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
                  "div",
                  {
                    className: "w-full cursor-pointer",
                    children: /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "inline-flex w-full items-center justify-start space-x-2 rounded-lg", children: [
                      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
                        "img",
                        {
                ...
                ((_d = searchUser.data) == null ? void 0 : _d.length) === 0 && userInput !== "" && !isFetchingUser && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { className: "text-red-400", children: "User not Found" })
              ] })
            ] }),
            filterData.type !== "comment" && /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "flex flex-col items-start justify-start space-y-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("p", { className: "text-sm font-semibold leading-tight", children: "Solved" }),
              /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "flex flex-col items-start justify-start space-y-0.5", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "flex w-full items-start justify-end gap-3 mt-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(Button, { onClick: apply, label: "Apply filters", type: "submit" }),
            /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(Button, { onClick: reset, color: "light", type: "reset", label: "reset" })
          ] })
        ] })
      ]
    }
...
// app/features/Post/Posts.tsx
var import_remix_utils2 = require("remix-utils"), import_react17 = require("@remix-run/react"), import_jsx_runtime15 = require("react/jsx-runtime");
function Posts({ editor }) {
  let filters = (0, import_recoil6.useRecoilValue)(filterDataState), isLatest = (0, import_recoil6.useRecoilValue)(showLatest), posts = (0, import_react17.useAsyncValue)();
  if (!posts)
    return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Skeleton, { number: 4, height: 80 });
  let lists = applyFilter(posts, filters, isLatest);
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(import_jsx_runtime15.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(import_remix_utils2.ClientOnly, { fallback: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(import_jsx_runtime15.Fragment, {}), children: () => /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Filter_default, {}) }),
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
      "div",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(import_react16.Suspense, { fallback: "loading", children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(import_remix_utils2.ClientOnly, { children: () => (lists == null ? void 0 : lists.length) > 0 && (lists == null ? void 0 : lists.map((post) => /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(import_Post2.default, { post, isOptimistic: !1 }, post.id))) }) })
      }
    )
  ] });
}
...
var import_jsx_runtime16 = require("react/jsx-runtime"), loader4 = async ({ request, params }) => {
  let textId = params.id && parseInt(params.id), threadId = new URL(request.url).searchParams.get("thread") ?? "";
  if (textId === "" || !textId)
    return (0, import_node6.redirect)("/");
  let posts = findPostByTextId(textId);
  return (0, import_node6.defer)({ text: { id: textId }, posts, threadId });
}, ErrorBoundary2 = ({ error }) => /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { children: error == null ? void 0 : error.message });
function PostContainer() {
  let data = useLiveLoader(), [, setParams] = (0, import_react19.useSearchParams)(), [selectedPostThread2, setSelectedThread] = (0, import_recoil7.useRecoilState)(
    selectedPostThread
  );
  ...
  let [isLatestPost, setIsLatestPost] = (0, import_recoil7.useRecoilState)(showLatest), setOpenFilter = (0, import_recoil7.useSetRecoilState)(openFilterState), translation = uselitteraTranlation(), { editor } = (0, import_react19.useOutletContext)();
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(import_jsx_runtime16.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: " w-full items-center justify-end inline-flex gap-2 mb-4 ", children: [
      /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(
        import_flowbite_react3.Dropdown,
        {
          label: /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(import_jsx_runtime16.Fragment, { children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "sort ml-2 text-sm font-medium leading-tight text-gray-500 dark:text-gray-50", children: "sort By" })
          ] }),
          size: "sm",
          color: "white",
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
              import_flowbite_react3.Dropdown.Item,
              {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "text-sm font-medium leading-tight text-gray-500 dark:text-gray-50", children: translation.filter })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(PostForm_default, {}),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(import_react18.Suspense, { fallback: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { children: "loading" }), children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(import_react19.Await, { resolve: data.posts, children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Posts_default, { editor }) }) })
  ] });
}
...
var action5 = async ({ request }) => {
  let user = await getUserSession(request), formData = await request.formData(), socket_id = formData.get("socket_id"), channel_name = formData.get("channel_name"), presenceData = {
    user_id: user.id,
    user_info: {
...
var loader6 = async ({ request }) => {
  ...
  if (sso && sig) {
    ...
    try {
      ...
      if (avatarUrl === null) {
        ...
        avatarUrl = "https://lopenling.org" + ((_a = res == null ? void 0 : res.user) == null ? void 0 : _a.avatar_template.replace("{size}", "30"));
      }
      if (!email || !name || !username)
        throw new Error("discourse SSO returned error URL");
      let userData = null, id, user = await isUserPresent(username);
      user ? id = user.id : (userData = await createUserInDB(
        username,
        name,
        email,
        admin === "true",
        avatarUrl
      ), id = userData == null ? void 0 : userData.id), session.set("user", {
        id,
        email,
        admin,
        name,
  ...
  if (_action === "login") {
    ...
    let session = await getSession(request.headers.get("Cookie"));
    return session.set("user", { ...user }), (0, import_server_runtime2.redirect)(redirectTo, {
      headers: {
        "set-cookie": await commitSession(session, { sameSite: "lax" })
      }
    });
...
var import_server_runtime3 = require("@remix-run/server-runtime"), import_react22 = require("@remix-run/react"), import_react23 = require("react");
...
// app/routes/text.upload.tsx
var import_react24 = require("react"), import_react_drag_drop_files = require("react-drag-drop-files"), import_flowbite_react5 = require("flowbite-react");

// app/component/Layout/Header.tsx
var import_react20 = require("@remix-run/react"), import_flowbite_react4 = require("flowbite-react");

// app/assets/logo.png
var logo_default = "/build/_assets/logo-M44S4BEM.png";

// app/component/Layout/Header.tsx
var import_react_littera3 = require("@assembless/react-littera"), import_react21 = require("react");
var import_recoil8 = require("recoil");

// app/features/Editor/index.jsx
var import_EditorContainer = __toESM(require_EditorContainer()), import_SearchString = __toESM(require_SearchString());

// app/component/Layout/Header.tsx
var import_react_detect_click_outside = require("react-detect-click-outside");
var import_jsx_runtime17 = require("react/jsx-runtime"), Logo = () => /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
  "img",
  {
...
), LogoWithTextName = ({ textName }) => (textName.length > 20 && isSmallScreen && (textName = textName.slice(0, 25) + "..."), /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "flex items-center gap-1", children: [
  /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(import_react20.Link, { to: "/", children: [
    " ",
...
function Header({ editor }) {
  var _a, _b, _c;
  let loginFetcher = (0, import_react20.useFetcher)(), themeFetcher = (0, import_react20.useFetcher)(), translation = uselitteraTranlation(), redirectTo = (0, import_react20.useLocation)().pathname, [TextNameOnHeader, setTextNameOnHeader] = (0, import_react21.useState)(!1), { name: textName } = (0, import_recoil8.useRecoilValue)(textInfo), { user } = (0, import_react20.useOutletContext)(), changeTheme = () => {
    var _a2;
    themeFetcher.submit(
      {
  ...
  (0, import_react21.useEffect)(() => {
    let timeout, editorElement = document.getElementById("textEditorContainer"), handleScroll = () => {
      timeout && clearTimeout(timeout), timeout = setTimeout(() => {
        let shouldShowTextName = (editorElement == null ? void 0 : editorElement.scrollTop) > 10 && redirectTo.includes("text");
        setTextNameOnHeader(shouldShowTextName);
      }, 10);
    };
    return editorElement == null || editorElement.addEventListener("scroll", handleScroll), () => editorElement == null ? void 0 : editorElement.addEventListener("scroll", handleScroll);
  }, [redirectTo, textName]);
  let darkMode = ((_a = user == null ? void 0 : user.preference) == null ? void 0 : _a.theme) === "dark", [showUserMenu, setShowUserMenu] = (0, import_react21.useState)(!1), [showHeaderMenu, setShowHeaderMenu] = (0, import_react21.useState)(!1), ref = (0, import_react_detect_click_outside.useDetectClickOutside)({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(
    "nav",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2", children: [
          TextNameOnHeader ? /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(LogoWithTextName, { textName }) : /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
          ...
          /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(
            "button",
            {
              ...
              "aria-expanded": "false",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("span", { className: "sr-only", children: "Open main menu" }),
                /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
                  "svg",
                  {
                    className: "w-6 h-6",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
            ...
            {
              ref: headermenuref,
              className: `${!showHeaderMenu && "hidden md:flex"}  items-center justify-center flex-col md:flex-row md:justify-end gap-2 md:order-2 w-full md:w-auto`,
              children: /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "w-full flex items-center justify-between pt-3 md:p-0", children: [
                ...
                user ? /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(import_jsx_runtime17.Fragment, { children: [
                  /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(
                    "button",
                    {
                      type: "button",
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("span", { className: "sr-only", children: "Open user menu" }),
                        /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
                          import_flowbite_react4.Avatar,
                          {
                            alt: user.name,
                            img: user.avatarUrl,
                            rounded: !0,
                  ...
                  showUserMenu && /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(
                    "div",
                    {
                      ref,
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "px-4 py-3", children: [
                          /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("span", { className: "block text-sm text-gray-900 dark:text-white", children: user.name }),
                          /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("span", { className: "block text-sm  text-gray-500 truncate dark:text-gray-400", children: /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
                            "a",
                            {
                              target: "_self",
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
                                "div",
                                {
                                  ...
                                  children: darkMode ? /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "flex gap-2 ", children: [
                                    /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
                                      "svg",
                                      {
                                        xmlns: "http://www.w3.org/2000/svg",
                                        ...
                                        fill: "currentColor",
                                        "aria-hidden": "true",
                                        className: `${((_b = themeFetcher.formData) == null ? void 0 : _b.get("theme")) && "animate-spin"} w-5 h-5`,
                                        children: /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
                                          "path",
                                          {
                                            fillRule: "evenodd",
                                    ...
                                    /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
                                      "svg",
                                      {
                                        ...
                                        fill: "currentColor",
                                        "aria-hidden": "true",
                                        className: `${((_c = themeFetcher.formData) == null ? void 0 : _c.get("theme")) && "animate-spin"} w-5 h-5`,
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(
                                "a",
                                {
                                  target: "_blank",
                                  href: `https://lopenling.org/u/${user == null ? void 0 : user.username}/preferences/account`,
                ...
                ] }) : /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "flex gap-2 justify-between", id: "user-menu-button", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(
                    loginFetcher.Form,
                    {
                      method: "POST",
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
                    import_flowbite_react4.Button,
                    {
                      ...
                      color: "",
                      id: "signup",
                      children: /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("a", { href: "https://lopenling.org/signup", children: translation.signup })
                    }
                  )
                ] })
              ] })
...
function Translation() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("div", { className: "md:mr-10 flex items-center justify-start space-x-0.5", children: /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
    "select",
    {
      onChange: (e) => {
      ...
      children: translationCodes.map((code) => /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
        "option",
        {
          value: code.code,
...
// app/routes/text.upload.tsx
var import_jsx_runtime18 = require("react/jsx-runtime"), loader7 = async ({ request }) => {
  ...
  let formData = await request.formData(), textName = formData.get("text-name"), textContent = formData.get("text-content"), user = await getUserSession(request), res = null;
  if (request.method === "DELETE") {
...
function UploadText() {
  var _a;
  let formRef = (0, import_react23.useRef)(), data = (0, import_react22.useLoaderData)(), user = data.user, navigation = (0, import_react22.useNavigation)(), [textContent, setTextContent] = (0, import_react23.useState)(""), uploadId = (0, import_react24.useId)();
  ...
  function readFileContent(file) {
    ...
    return new Promise((resolve, reject) => {
      reader.onload = (event) => resolve(event.target.result), reader.onerror = (error) => reject(error), reader.readAsText(file);
    });
  }
  let fileTypes = ["TXT"];
  return user ? /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)(import_jsx_runtime18.Fragment, { children: [
    " ",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)(
      import_react22.Form,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)(import_flowbite_react5.Tabs.Group, { "aria-label": "Default tabs", style: "default", children: [
            /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(import_flowbite_react5.Tabs.Item, { title: "Type text", children: /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: "mb-6", children: [
              /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
                "label",
                {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(import_flowbite_react5.Tabs.Item, { title: "Upload Txt", children: /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(import_react_drag_drop_files.FileUploader, { handleChange, types: fileTypes }) })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
            "button",
            {
              ...
              children: navigation.state !== "idle" && navigation.formMethod === "POST" ? " Text uploading" : "Upload"
            }
          )
        ]
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("div", { className: "flex flex-col space-y-3 w-max mx-auto text-lg", children: data.textList.map((text) => /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(EachText, { text }, text.id)) })
...
function EachText({ text }) {
  ...
  function handleDeleteText(textId) {
    confirm("do you wish to delete the text") && deleteFetcher.submit(
      {
        textId
      },
      {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: "flex  gap-3 items-center justify-between", children: [
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("div", { style: { fontFamily: "sans-serif" }, children: (_a = text.author) == null ? void 0 : _a.name }),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)(
      "div",
      {
...
var action8 = async ({ request }) => {
  ...
  try {
    ...
    if (request.method === "POST") {
      ...
      ), formData = await (0, import_node7.unstable_parseMultipartFormData)(request, uploadHandler), Obj = Object.fromEntries(formData), postString = Obj.postString, topicId = Obj.topicId, audioUrl = Obj.file;
      return audioUrl === void 0 && (audioUrl = null), {
        posts: await (await createPost(
          topicId,
          audioUrl,
          postString,
          user.username
...
var action9 = async ({ request }) => {
  ...
  if (request.method === "POST") {
    let formData = await (0, import_node8.unstable_parseMultipartFormData)(request, uploadHandler), Obj = Object.fromEntries(formData), DiscourseUrl = process.env.DISCOURSE_SITE, api = process.env.DISCOURSE_API_KEY, parent_category_id = process.env.DISCOURSE_QA_CATEGORY_ID;
    if (!user)
      throw new Error("user not logged in");
    if (!DiscourseUrl || !api || !parent_category_id)
      throw new Error("set a DISCOURSE_SITE/DISCOURSE_API_KEY in env");
    let audioUrl = Obj.file, textId = parseInt(Obj.textId);
    try {
  ...
  if (request.method === "DELETE") {
    let formData = await request.formData(), id = Object.fromEntries(formData).id, res = await deletePost2(id), deleteDiscourse = await deleteDiscourseTopic(
      user.username,
      res.topic_id
    );
    return {
  ...
  if (request.method === "PATCH") {
    let formData = await (0, import_node8.unstable_parseMultipartFormData)(request, uploadHandler), action11 = formData.get("action");
    if (action11 === "like") {
    ...
    if (action11 === "update") {
      ...
      return res != null && res.post_id && await updateDiscoursePost(
        res.post_id,
        newContent,
        audioUrl,
        user.username
...
var loader8 = async ({ request }) => {
  let textId = new URL(request.url).searchParams.get("textId") ?? "", text = await findTextByTextId(parseInt(textId), !0);
  return (0, import_react_router4.json)(text);
}, action10 = async ({ request }) => {
  let data = await request.formData(), user = await getUserSession(request), dmp = new import_diff_match_patch2.default(), patchString = data.get("patch"), patch = dmp.patch_fromText(JSON.parse(patchString)), id = data.get("id"), text = await findTextByTextId(parseInt(id), !0), [newText, result] = dmp.patch_apply(patch, text.content);
  try {
...
var import_node9 = require("@remix-run/node"), import_react33 = require("@remix-run/react"), import_react34 = require("react");
var import_recoil11 = require("recoil"), import_react35 = require("@tiptap/react");
      ...
      new import_prosemirror_state.Plugin({
        props: {
          handleClick(view, pos, event) {
            let { schema, doc, tr } = view.state, range = (0, import_core.getMarkRange)(
              doc.resolve(pos),
...
var import_core3 = require("@tiptap/core"), import_prosemirror_view = require("prosemirror-view"), import_prosemirror_state3 = require("prosemirror-state"), getRegex = (s, disableRegex, caseSensitive) => RegExp(
...
function processSearches(doc, searchTerm, searchResultClass) {
  ...
  for (let i = 0; i < textNodesWithPosition.length; i += 1) {
    let { text, pos } = textNodesWithPosition[i], matches = Array.from(text.matchAll(searchTerm)).filter(
  ...
  for (let i = 0; i < results.length; i += 1) {
    let r = results[i];
    decorations.push(
      import_prosemirror_view.Decoration.inline(r.from, r.to, { class: searchResultClass })
    );
  }
  return {
...
var searchAndReplacePluginKey = new import_prosemirror_state3.PluginKey(
  ...
  doc.descendants((node, pos) => {
    node.marks && node.marks.forEach((mark) => {
      if (mark.attrs.id === markID) {
        let from = pos, to = pos + node.nodeSize, trx = editor.view.state.tr.setSelection(
...
var import_react25 = require("react"), import_react_detect_click_outside2 = require("react-detect-click-outside"), import_react26 = require("@remix-run/react");
var import_jsx_runtime19 = require("react/jsx-runtime");
function Comments({ comments }) {
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(import_jsx_runtime19.Fragment, { children: comments.length > 0 && comments.map((comment, index) => /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Comment, { comment }, comment.id)) });
}
var Comment = ({ comment }) => {
  var _a, _b;
  let [openEditMenu, setOpenEditMenu] = (0, import_react25.useState)(!1), [edit, setEdit] = (0, import_react25.useState)(!1), [newContent, setNewContent] = (0, import_react25.useState)(comment.text), [checked, setChecked] = (0, import_react25.useState)(comment.type === "support"), { user } = (0, import_react26.useOutletContext)(), ref = (0, import_react_detect_click_outside2.useDetectClickOutside)({
    onTriggered: () => setOpenEditMenu(!1)
  }), color = comment.type === "support" ? "bg-green-100" : comment.type === "reject" ? "bg-red-100" : null, time = timeAgo(comment.createdAt), fetcher = (0, import_react26.useFetcher)(), handleEdit = () => {
    setEdit(!0);
  }, handleDelete = () => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: `p-2 text-base  rounded-lg dark:bg-gray-700 ${color}`, children: [
    /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "flex justify-between items-center mb-2", children: [
      /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "flex items-center", children: [
        /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("p", { className: "inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("p", { className: "text-sm text-gray-600 dark:text-gray-400", children: time })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "relative ml-3", ref, children: [
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
          "button",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
              "svg",
              {
                ...
                viewBox: "0 0 20 20",
                xmlns: "http://www.w3.org/2000/svg",
                children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("path", { d: "M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" })
              }
            )
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
          "div",
          {
            className: `${openEditMenu ? "absolute" : "hidden"} right-0 top-1.5 z-10 w-36 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600`,
            children: /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(
              "ul",
              {
                ...
                children: [
                  user && user.username === (comment == null ? void 0 : comment.author.username) && /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "block py-2 cursor-pointer px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white", children: "Report" }) })
                ]
              }
            )
          }
    ...
    edit ? /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "flex flex-col", children: [
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
        TextArea_default,
        {
          value: newContent,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "flex justify-between gap-2 mt-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "flex-1 ", children: [
          /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("label", { htmlFor: "checkbox" + comment.id, className: "mr-2", children: "support" }),
          /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
            "input",
            {
              type: "checkbox",
          ...
          audioPresent && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(import_AudioPlayer.default, { src: comment.audioUrl })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Button, { onClick: handleSubmit, label: "submit", type: "submit" }),
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
          Button,
          {
            onClick: () => setEdit(!1),
      ...
      audioPresent && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(import_AudioPlayer.default, { src: comment.audioUrl }),
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("p", { className: "text-gray-500 dark:text-gray-400", children: comment.text })
    ] })
  ] });
};
function oo_cm10() {
...
function Suggestion2({
  ...
  var _a, _b, _c;
  let likeFetcher = useFetcherPromise_default(), deleteFetcher = (0, import_react27.useFetcher)(), editFetcher = (0, import_react27.useFetcher)(), { user } = (0, import_react27.useOutletContext)(), [effect, setEffect] = (0, import_react28.useState)(!1), [openEdit, setOpenEdit] = (0, import_react28.useState)(!1), [openComment, setOpenComment] = (0, import_react28.useState)(!1), [openEditMenu, setOpenEditMenu] = (0, import_react28.useState)(!1), { text } = (0, import_react27.useLoaderData)(), ref = (0, import_react_detect_click_outside3.useDetectClickOutside)({
    onTriggered: () => setOpenEditMenu(!1)
  });
  if (!user)
    return null;
  let likedByMe = user ? suggest.likedBy.some((l) => (l == null ? void 0 : l.username) === user.username) : !1, likeInFetcher = (_a = likeFetcher == null ? void 0 : likeFetcher.formData) == null ? void 0 : _a.get("like"), likeCount = likeFetcher.data ? (_b = likeFetcher.data) == null ? void 0 : _b.likedBy.likedBy.length : suggest.likedBy.length;
  ...
  return deleteFetcher.data && ((_c = deleteFetcher.data) == null ? void 0 : _c.remain) === 0 && (editor == null || editor.commands.unsetSuggestion()), suggest.user ? /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(
    "div",
    {
      className: `${deleteFetcher.formData && "hidden"} p-3 `,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "relative flex justify-between mb-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "  flex gap-3", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("p", { className: "text-base font-medium leading-tight text-gray-900 dark:text-gray-200", children: suggest.user.name }),
            /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("p", { className: "text-sm text-gray-600 dark:text-gray-400", children: time })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
            "button",
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
                "svg",
                {
                  ...
                  viewBox: "0 0 20 20",
                  xmlns: "http://www.w3.org/2000/svg",
                  children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("path", { d: "M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" })
                }
              )
            }
          ),
            ...
            "div",
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(
                "ul",
                {
                  ...
                  "aria-labelledby": "dropdownMenuIconHorizontalButton",
                  children: [
                    user && user.username === suggest.user.username && /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(import_jsx_runtime20.Fragment, { children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { className: "block py-2 cursor-pointer px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white", children: "Report" }) })
                  ]
                }
              )
            }
        ...
        /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: " w-full text-base leading-normal text-black mb-3", children: [
          /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("span", { className: "font-bold text-sm", children: "Replace :" }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("span", { className: "font-bold text-sm", children: " with :" }),
          openEdit ? /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(
            editFetcher.Form,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("input", { name: "id", type: "text", value: suggest.id, hidden: !0 }),
                /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
                  Button,
                  {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { className: "mb-2", children: (suggest == null ? void 0 : suggest.audioUrl) && suggest.audioUrl !== "" && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_AudioPlayer.default, { src: suggest == null ? void 0 : suggest.audioUrl }) }),
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { className: "flex justify-between", children: optimistic ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { className: "text-sm text-light ", children: "saving" }) : /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(import_jsx_runtime20.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { className: "flex gap-4", children: /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { className: "  text-sm font-medium leading-tight text-gray-500 dark:text-gray-100", children: likeCount > 0 && likeCount })
              ]
            }
          ) }),
          /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(
...
function CommentSection({ id, setOpenComment, comments, type }) {
  let [commentText, setCommentText] = (0, import_react28.useState)(""), [audio, setAudio] = (0, import_react28.useState)({ tempUrl: "", blob: null }), data = (0, import_react27.useLoaderData)(), postCommentFetcher = (0, import_react27.useFetcher)();
  function postComment() {
    ...
    var form_data = new FormData();
    blob && form_data.append("file", blob, `text-${(_a = data == null ? void 0 : data.text) == null ? void 0 : _a.id}-${(0, import_uuid2.v4)()}.wav`);
    for (var key in item)
      form_data.append(key, item[key]);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { className: "flex justify-between pt-1 gap-2 bg-gray-100  rounded mt-2", children: /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "flex flex-col gap-2 flex-1 ", children: [
    /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
      TextArea_default,
      {
    ...
    audio.tempUrl !== "" ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_jsx_runtime20.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "w-full flex items-center gap-3 my-2", children: [
      /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_AudioPlayer.default, { src: audio.tempUrl }),
      /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { onClick: () => setAudio({ tempUrl: "", blob: null }), children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
        "svg",
        {
          width: "20",
          height: "20",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "flex justify-between", children: [
      audio.tempUrl === "" ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_AudioRecorder.default, { setAudio }) : /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", {}),
...
function Suggestions({
  ...
  let suggestionThread = (0, import_recoil9.useRecoilValue)(selectedSuggestionThread), list = suggestions.filter((sug) => sug.threadId === suggestionThread.id);
  return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(
    "div",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)("div", { className: "flex flex-col  gap-2 ", children: [
        /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("h2", { className: "text-lg lg:text-2xl font-bold text-gray-900 dark:text-white", children: "Suggestion" }),
        list.map((suggest) => /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(
          Suggestion2,
          {
            optimistic: !1,
            editor,
...
var import_react29 = require("@remix-run/react"), import_react30 = require("react"), import_recoil10 = require("recoil");
var import_uuid3 = require("uuid");
var import_jsx_runtime22 = require("react/jsx-runtime");
function SuggestionForm({ editor }) {
  var _a, _b, _c, _d, _e, _f;
  let data = (0, import_react29.useLoaderData)(), { user } = (0, import_react29.useOutletContext)(), [suggestionInput, setSuggestionInput] = (0, import_react30.useState)(""), [error, setError] = (0, import_react30.useState)(null), addSuggestion = useFetcherPromise_default(), setSelectedSuggestion = (0, import_recoil10.useSetRecoilState)(selectedSuggestionThread), setOpenSuggestion = (0, import_recoil10.useSetRecoilState)(openSuggestionState), [audio, setAudio] = (0, import_react30.useState)({ tempUrl: "", blob: null }), handleSuggestionSubmit = async () => {
    var _a2;
    if (suggestionInput === "")
    ...
    editor.isActive("suggestion") ? id = editor.getAttributes("suggestion").id : id = (0, import_uuid3.v4)(), setSelectedSuggestion({
      id
    });
    let item = {
    ...
    var form_data = new FormData();
    blob && form_data.append("file", blob, `text-${(_a2 = data == null ? void 0 : data.text) == null ? void 0 : _a2.id}-${(0, import_uuid3.v4)()}.wav`);
    for (var key in item)
      form_data.append(key, item[key]);
  ...
  return user ? isPosting ? /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("div", { className: "p-2 bg-slate-50 dark:bg-gray-700 shadow-md ", children: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("div", { className: "flex flex-col gap-2 ", children: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
    Suggestion2,
    {
      editor: null,
      optimistic: !0,
  ...
  ) }) }) : /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("div", { className: "p-2 ml-2 bg-slate-50 dark:bg-gray-700 shadow-md mb-2", children: [
    ((_e = addSuggestion.data) == null ? void 0 : _e.message) && /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("div", { className: "font-sm text-red-500", children: (_f = addSuggestion.data) == null ? void 0 : _f.message }),
    ...
    audio.tempUrl !== "" ? /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(import_jsx_runtime22.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("div", { className: "w-full flex items-center gap-3 mt-2", children: [
      /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(import_AudioPlayer.default, { src: audio.tempUrl }),
      /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("div", { onClick: () => setAudio({ tempUrl: "", blob: null }), children: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
        "svg",
        {
          width: "20",
          height: "20",
    ...
    error && /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("div", { className: "text-red-400", children: error }),
    /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("div", { className: "flex justify-between", children: [
      audio.tempUrl === "" ? /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(import_AudioRecorder.default, { setAudio }) : /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("div", {}),
      /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("div", { className: "flex justify-end mt-3 gap-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
          Button,
          {
...
var import_react31 = require("react"), import_pusher_js = __toESM(require("pusher-js")), import_react32 = require("@remix-run/react"), usePusherPresence = (channelName, id, cluster, fetchUpdateText, user) => {
  let [onlineMembers, setOnlineMembers] = (0, import_react31.useState)([]), { revalidate } = (0, import_react32.useRevalidator)();
...
// app/routes/text.$id.tsx
var import_react_device_detect2 = require("react-device-detect"), import_remix_utils3 = require("remix-utils"), import_jsx_runtime23 = require("react/jsx-runtime"), loader9 = async ({ request, params }) => {
  let text_id = parseInt(params.id), text = await findTextByTextId(text_id, !1), suggestions = await findAllSuggestionByTextId(text_id);
...
function ErrorBoundary3({ error }) {
  return console.error(error), /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("div", { children: "ohh Snap! There is an error" });
}
var meta2 = ({ data }) => {
  var _a;
...
function text_id_default() {
  var _a, _b;
  let data = useLiveLoader(), setTextName = (0, import_recoil11.useSetRecoilState)(textInfo), [contentData, setContent] = (0, import_react34.useState)(""), setSelectionRange = (0, import_recoil11.useSetRecoilState)(selectedTextOnEditor), { user } = (0, import_react33.useOutletContext)(), [suggestionSelected, suggestionSelector] = (0, import_recoil11.useRecoilState)(
    selectedSuggestionThread
  ), [openSuggestion, setOpenSuggestion] = (0, import_recoil11.useRecoilState)(openSuggestionState), postSelector = (0, import_recoil11.useSetRecoilState)(selectedPostThread);
  ...
  function fetchUpdateText() {
    var _a2;
    fetch(`/api/text?textId=${(_a2 = data == null ? void 0 : data.text) == null ? void 0 : _a2.id}`).then((res) => res.json()).then((data2) => {
  ...
  let getQuery = (0, import_react34.useCallback)(
    (newContent) => {
      let oldContent = contentData, dmp = new import_diff_match_patch.default();
    ...
    []
  ), saveTextFetcher = (0, import_react33.useFetcher)(), saveData = async (patch) => {
    var _a2;
    let formData = new FormData();
    formData.append("id", (_a2 = data.text) == null ? void 0 : _a2.id), formData.append("patch", JSON.stringify(patch)), saveTextFetcher.submit(formData, {
      method: "POST",
      action: "/api/text"
    });
  };
  if (!data.text)
    return /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("div", { className: "text-red-700 flex gap-2 items-center justify-center capitalize", children: [
      /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("p", { children: "text not available" }),
      /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(import_react33.Link, { className: "text-blue-600 underline", to: "/", children: "go back" })
    ] });
  ...
  return editor ? /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("div", { className: " flex flex-col h-screen", children: [
    /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(Header_default, { editor }),
    /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(OnlineUserList_default, { onlineMembers, count: onlineMembers.length }),
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)(
          import_react_split.default,
          {
            ...
            sizes: import_react_device_detect2.isMobile ? [50, 50] : import_react_device_detect2.isTablet ? [60, 40] : [65, 35],
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(import_remix_utils3.ClientOnly, { fallback: /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("div", { children: "load" }), children: () => /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(
                    import_EditorContainer.default,
                    {
                      editor,
                      isSaving,
                      content: contentData
              ...
              /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)(
                "div",
                {
                  ...
                  children: [
                    openSuggestion || (suggestionSelected == null ? void 0 : suggestionSelected.id) ? /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(SuggestionForm, { editor }) : /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(import_react33.Outlet, { context: { user, editor, text: data.text } }),
                    suggestionSelected != null && suggestionSelected.id ? /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(import_react34.Suspense, { fallback: "loading", children: /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(import_react33.Await, { resolve: data.suggestions, children: (data2) => /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(SuggestionContainer_default, { editor, suggestions: data2 }) }) }) : null
                  ]
                }
              )
            ]
...
var import_react36 = require("@remix-run/react"), import_flowbite_react6 = require("flowbite-react");
...
function FooterContainer() {
  return /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)(import_jsx_runtime24.Fragment, { children: [
    " ",
    /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("div", { className: " text-3xl capitalize font-extrabold items-center justify-center flex h-48", children: "our partners" }),
    /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("div", { className: "flex flex-col w-full items-center justify-center bg-green-700 h-[350px]", children: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(
      "img",
      {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("footer", { className: "bg-white dark:bg-gray-900", children: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("div", { className: "mx-auto w-full ", children: /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("div", { className: "px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between", children: [
      /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("span", { className: "text-sm text-gray-500 dark:text-gray-300 sm:text-center", children: [
        "\xA9 2023 ",
        /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("a", { href: "https://flowbite.com/", children: "Lopenling\u2122" }),
        ". All Rights Reserved."
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("div", { className: "flex mt-4 space-x-6 sm:justify-center md:mt-0", children: [
        /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)(
          "a",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("span", { className: "sr-only", children: "Facebook page" })
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)(
          "a",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("span", { className: "sr-only", children: "Instagram page" })
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)(
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(
                "svg",
                {
                  ...
                  viewBox: "0 0 24 24",
                  "aria-hidden": "true",
                  children: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("path", { d: "M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" })
                }
              ),
              /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("span", { className: "sr-only", children: "Twitter page" })
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)(
          "a",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("span", { className: "sr-only", children: "GitHub account" })
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)(
          "a",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("span", { className: "sr-only", children: "Dribbble account" })
            ]
          }
        )
      ] })
...
var import_jsx_runtime25 = require("react/jsx-runtime"), loader10 = async ({ request }) => {
  var _a;
  ...
  if (searchText) {
    let obj = await searchTextWithName(searchText), textList = Object.keys(obj).map((key) => ({
      name: obj[key].name,
...
function Index() {
  var _a;
  let data = (0, import_react37.useLoaderData)(), navigation = (0, import_react37.useNavigation)(), translation = uselitteraTranlation(), [params] = (0, import_react36.useSearchParams)(), [searchInput, setSearchInput] = (0, import_react38.useState)("");
  ...
  return lists != null && lists.message ? /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("div", { className: "text-red-400", children: lists == null ? void 0 : lists.message }) : /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)(
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)(
          "div",
          {
            ...
            style: { paddingTop: 60 },
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("div", { className: "inline-flex w-full items-center justify-center  px-3 md:px-1.5 pt-24  ", children: /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(import_react36.Form, { method: "GET", className: "w-full max-w-2xl", children: /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("div", { className: "relative flex w-full space-x-3 ", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("div", { className: "inline-flex  w-full flex-col items-center justify-start space-y-3.5 py-10", children: [
                isLoading && /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(Skeleton, { height: 125, number: 3 }),
                lists && !isLoading && /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)(import_jsx_runtime25.Fragment, { children: [
                  lists.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(
                    "div",
                    {
                        ...
                        import_react36.Link,
                        {
                          ...
                          children: /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)(
                            import_flowbite_react6.Card,
                            {
                              ...
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("div", { className: "text-xl", children: list.name }),
                                /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("div", { className: "flex flex-wrap justify-between text-sm", children: [
                                  result && result[1],
                                  /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("div", { className: "text-sm text-gray-400", children: [
                                    list.total,
                                    " matches"
                                  ] })
                                ] })
...
var FeatureSection = () => /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("section", { className: "bg-gray-50 dark:bg-gray-700", children: /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("div", { className: "py-8 px-4 mx-auto max-w-screen-xl text-center sm:py-16 lg:px-6", children: [
  /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("h2", { className: "mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white", children: "Welcome to Lopenling" }),
  /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("p", { className: "text-gray-500 sm:text-xl dark:text-gray-400", children: "Here are a few reasons to use Lopenling" }),
  /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("div", { className: "mt-8 lg:mt-12 space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0", children: [
    /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("div", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("h3", { className: "mb-2 text-xl font-bold dark:text-white", children: "Accesibility" }),
      /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("p", { className: "mb-4 text-gray-500 dark:text-gray-400", children: "The vast majority of digital text assets are stored in secure storage. Sharing text is easier than ever." }),
      /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)(
        "a",
        {
          href: "#",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("div", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("h3", { className: "mb-2 text-xl font-bold dark:text-white", children: "Community" }),
      /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("p", { className: "mb-4 text-gray-500 dark:text-gray-400", children: "We are proud to have a thriving and expansive community that actively utilizes our app ." }),
      /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)(
        "a",
        {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("div", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("h3", { className: "mb-2 text-xl font-bold dark:text-white", children: "Data Driven" }),
      /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("p", { className: "mb-4 text-gray-500 dark:text-gray-400", children: "Our app offers real-time text editing, empowering users to collaborate and make instant modifications to their content." }),
      /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)(
        "a",
        {
          href: "#",
