...
function EditorContainer({ editor, isSaving, page, saveTextFetcher }) {
  ...
  }, [annotations?.length, page.content]), (0, import_react19.useEffect)(() => {
...
function Page() {
  let data = (0, import_react50.useLoaderData)(), { page } = data, saveTextFetcher = (0, import_react50.useFetcher)(), editor = useEditorInstance_default(void 0, !1), withImage = !data.text.allow_post;
