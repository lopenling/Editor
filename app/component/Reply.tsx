...
function EachReply({
  ...
  const likedByMe = replyList?.likedBy?.some(
    (d) => d.username == data.user.username
  );
      ...
      <div className="flex justify-between">
        ...
        >
          ...
          <button
            ...
            className=" disabled:text-slate-300 text-sm font-medium leading-tight text-gray-500"
          >
