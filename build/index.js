...
var globalStyle_default = "/build/_assets/globalStyle-KYKLLKJB.css";

// app/styles/tailwind.css
var tailwind_default = "/build/_assets/tailwind-HJHEIW67.css";
...
var import_react12 = require("@remix-run/react"), useEditorInstance = (isEditable, paramUpdate = !0) => {
  ...
  return (0, import_react11.useEditor)(
    {
      ...
      onSelectionUpdate: ({ editor: editor2 }) => {
        ...
        }), !editor2.isActive("suggestion") && !editor2.isActive("post") && param.get("with") !== "all" && setSearchParams((p) => (p.set("with", "all"), p));
      }
    },
    []
  );
...
function TranslationsRoute() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime15.jsxDEV)(import_jsx_dev_runtime15.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime15.jsxDEV)("div", { className: "flex max-w-6xl gap-3 w-full mx-auto mt-3", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime15.jsxDEV)("div", { className: "flex-1 block p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 max-h-[80vh] overflow-y-scroll", children: [
...
var import_react15 = require("@remix-run/react"), import_fa4 = require("react-icons/fa"), import_jsx_dev_runtime16 = require("react/jsx-dev-runtime");
function Pagination({ pageCount }) {
  let data = (0, import_react15.useLoaderData)(), textId = data.text.id, order = parseInt(data.order), [searchParams] = (0, import_react15.useSearchParams)(), version = searchParams.get("version"), PreviousLink = `/text/${textId}/page/${order - 1}${version ? "/?version=" + version : ""}`, nextLink = `/text/${textId}/page/${order + 1}${version ? "/?version=" + version : ""}`;
  return /* @__PURE__ */ (0, import_jsx_dev_runtime16.jsxDEV)("div", { className: "flex justify-end gap-3", children: [
    order - 1 > 0 && /* @__PURE__ */ (0, import_jsx_dev_runtime16.jsxDEV)(import_react15.Link, { to: PreviousLink, className: "mr-1 flex items-center gap-2 rounded  p-1", children: [
    ...
    order + 1 <= pageCount && /* @__PURE__ */ (0, import_jsx_dev_runtime16.jsxDEV)(import_react15.Link, { to: nextLink, className: "mr-1 flex items-center gap-2 rounded  p-1", children: [
      "next",
...
var import_react16 = require("react"), import_jsx_dev_runtime17 = require("react/jsx-dev-runtime"), Controls = ({ zoomIn, zoomOut, resetTransform, url }) => ((0, import_react16.useEffect)(() => {
  resetTransform();
...
function EditorContainer({ editor, isSaving, page, saveTextFetcher }) {
  ...
  }, [annotations?.length]), (0, import_react19.useEffect)(() => {
    (!searchString || searchString.length === 0) && editor.commands.setSearchTerm("");
  }, [searchString]), (0, import_react19.useEffect)(() => {
...
var import_react20 = require("@remix-run/react"), import_ai3 = require("react-icons/ai"), import_io2 = require("react-icons/io"), import_jsx_dev_runtime19 = require("react/jsx-dev-runtime");
function TextHeader() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime19.jsxDEV)("div", { className: "bg-gray-50  flex justify-between items-center border-t py-3", style: { height: 60 }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime19.jsxDEV)("div", { className: "flex justify-between items-center lg:px-9 md:px-3 max-w-3xl w-full mx-auto", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime19.jsxDEV)(import_react20.Link, { to: "/", children: /* @__PURE__ */ (0, import_jsx_dev_runtime19.jsxDEV)(import_ai3.AiOutlineClose, { size: 30, color: "gray" }, void 0, !1, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime19.jsxDEV)(import_react20.Link, { to: loc.pathname + "?with=all", children: /* @__PURE__ */ (0, import_jsx_dev_runtime19.jsxDEV)(import_io2.IoIosOptions, { size: 30, color: "gray" }, void 0, !1, {
      fileName: "app/component/Layout/TextHeader.tsx",
      lineNumber: 18,
      columnNumber: 11
    }, this) }, void 0, !1, {
...
var import_react21 = require("@remix-run/react"), import_ai4 = require("react-icons/ai"), import_io3 = require("react-icons/io"), import_jsx_dev_runtime20 = require("react/jsx-dev-runtime");
function MenuHeader() {
...
function MenuHome() {
  let li_className = "hover:text-gray-500 cursor-pointer", [, setSearchParams] = (0, import_react22.useSearchParams)();
...
var import_jsx_dev_runtime22 = require("react/jsx-dev-runtime"), TableOfContents = ({ editor }) => {
  let [isOpen, setIsOpen] = (0, import_react24.useState)(!1), [isVersionOpen, setIsVersionOpen] = (0, import_react24.useState)(!0), data = (0, import_react23.useLoaderData)(), translation = uselitteraTranlation(), handleDropdownToggle = () => {
    setIsOpen(!isOpen);
  }, handleVersionToggle = () => {
...
function Translations() {
  ...
  return console.log(...oo_oo7("2253005103_61_2_61_27_4", translations)), /* @__PURE__ */ (0, import_jsx_dev_runtime24.jsxDEV)("div", { children: [
...
function Post({ isOptimistic, post, showDivider, editor }) {
  ...
  async function deletePost3() {
    ...
    ) : console.log(...oo_oo8("865681764_101_6_101_30_4", "cancelled"));
  }
...
function PostSidebar({ createPost: createPost3, editor }) {
  let data = (0, import_react41.useLoaderData)(), [params, setParams] = (0, import_react41.useSearchParams)(), selectedId = params.get("thread");
...
function CommentSection({ id, setOpenComment, comments, type }) {
  let [commentText, setCommentText] = (0, import_react45.useState)(""), [audio, setAudio] = (0, import_react45.useState)({ tempUrl: "", blob: null }), data = (0, import_react44.useLoaderData)(), postCommentFetcher = (0, import_react44.useFetcher)();
...
function Suggestions({ editor }) {
  let { suggestions } = (0, import_react46.useLoaderData)(), groupedSuggestion = transformObjectsByNewValue(suggestions);
...
function Page() {
  let data = (0, import_react50.useLoaderData)(), { page } = data, saveTextFetcher = (0, import_react50.useFetcher)(), editor = useEditorInstance_default(!1), withImage = !data.text.allow_post;
...
function Index() {
  let data = (0, import_react58.useLoaderData)(), navigation = (0, import_react58.useNavigation)(), [params] = (0, import_react57.useSearchParams)(), [searchInput, setSearchInput] = (0, import_react59.useState)(""), translation = uselitteraTranlation(), handleInputChange = (event) => {
