...
function EditorContainer({ editor, isSaving, page, saveTextFetcher }) {
  ...
  (0, import_react19.useEffect)(() => {
    ...
    }, 1e3), setImage({ ...Image2, url: imageUrl });
...
function MenuHeader() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)("div", { className: "w-full uppercase text-gray-500 h-[60px]  bg-gray-100 flex items-center justify-between px-6 py-4", children: [
    header === "all" ? "Resources" : /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)("button", { type: "button", onClick: () => setSearchParams({ with: "all" }), children: /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)(import_io3.IoIosArrowRoundBack, { size: 30 }, void 0, !1, {
...
function Post({ isOptimistic, post, showDivider, editor }) {
  ...
  async function deletePost3() {
    ...
    ) : console.log(...oo_oo8("3918770975_97_6_97_30_4", "cancelled"));
  }
...
function Page() {
  let data = (0, import_react50.useLoaderData)(), { page, annotations } = data, saveTextFetcher = (0, import_react50.useFetcher)(), newContent = checkunknown_default(page.content.replace(/[\r\n]+/g, "<p/><p>")), content = generateHtmlFromTextAndAnnotations(newContent, annotations), editor = useEditorInstance_default(content, !1), withImage = !data.text.allow_post;
...
var loader6 = async ({ request }) => {
  ...
  if (request.method === "POST") {
    ...
    try {
      ...
      return console.log(...oo_oo14("2558164162_45_6_45_27_4", responce)), { responce };
    } catch (e) {
      return console.log(...oo_oo14("2558164162_48_6_48_20_4", e)), { message: e };
    }
  } else {
    ...
    if (request.method === "DELETE") {
      ...
      if (count === 0) {
        ...
        console.log(...oo_oo14("2558164162_62_8_62_38_4", delete_annotation));
      }
      return {
        remain: count
      };
...
var action10 = async ({ request }) => {
  ...
  if (request.method === "DELETE") {
    let formData = await request.formData(), Obj = Object.fromEntries(formData), id = Obj.id, threadId = Obj.threadId;
    console.log(...oo_oo15("1666537872_78_4_78_19_4", id));
  ...
  if (request.method === "PATCH") {
    ...
    if (action12 === "like") {
      ...
      try {
        ...
        console.log(...oo_oo15("1666537872_108_8_108_22_4", e));
      }
      return { success: !0 };
    }
    if (action12 === "update") {
