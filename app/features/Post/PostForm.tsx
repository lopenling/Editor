...
const PostForm = () => {
  ...
  return (
    <section className=" mb-3 rounded bg-gray-100 p-3 shadow">
      <div className="flex items-start justify-between">
        <div className="mb-3 text-base font-medium capitalize leading-tight text-gray-900 dark:text-gray-300">
