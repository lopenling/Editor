...
function EachText({ text }: PropsType) {
  ...
  return (
    <div
      className={`rounded py-1 px-2 relative 
    ...
    >
      ...
      <button
        ...
        className="absolute -top-2 -right-2 inline-flex h-6 w-6 items-center justify-center rounded-full border-2  bg-red-500 text-xs font-bold  dark:border-gray-900"
      >
        x
      </button>
    </div>
