...
var globalStyle_default = "/build/_assets/globalStyle-YBBFLEE4.css";

// app/styles/tribute.css
var tribute_default = "/build/_assets/tribute-JM5KLPGZ.css";

// app/styles/tailwind.css
var tailwind_default = "/build/_assets/tailwind-6FYD653C.css";
...
function Skeleton({ height, number }) {
  let items = Array.from({ length: number }, (_2, index) => index + 1);
...
var handleDOMEvents = {
  ...
  paste: (v, event) => {
    event.preventDefault(), console.log(...oo_oo2("2262323656_0", v));
  }
}, editorProps = {
  handleDOMEvents,
  attributes: {
...
async function getVersions(textId, order) {
  try {
    ...
    return console.log(...oo_oo5("2066324894_1", e)), [];
  }
}
async function getPage(textId, order, version) {
  try {
    ...
    console.log(...oo_oo5("2066324894_2", e));
  }
}
async function getPageId(textId, order) {
  try {
    ...
    console.log(...oo_oo5("2066324894_3", e));
  }
}
...
var import_node4 = require("@remix-run/node"), import_react46 = require("@remix-run/react");
var import_recoil15 = require("recoil"), import_react47 = require("react");
...
// app/features/Editor/component/EditorContainer.tsx
var import_lodash = __toESM(require("lodash")), import_jsx_dev_runtime21 = require("react/jsx-dev-runtime");
function EditorContainer({
  ...
  let { annotations } = (0, import_react23.useLoaderData)(), data = (0, import_react23.useLoaderData)(), user = data.user, [Image2, setImage] = (0, import_recoil9.useRecoilState)(ImageState), isPostAllowed = data.text.allow_post, [openSuggestion, setOpenSuggestion] = (0, import_recoil9.useRecoilState)(openSuggestionState), [selection, setSelectionRange] = (0, import_recoil9.useRecoilState)(selectedTextOnEditor), thread = (0, import_recoil9.useRecoilValue)(selectedPostThread), saving = saveTextFetcher.state !== "idle";
  (0, import_react25.useEffect)(() => {
    let timer = scrollThreadIntoView(thread.id, `p_${thread.id}`);
    return editor.on("update", async ({ editor: editor2 }) => {
      let newContent = editor2.getHTML(), { text, annotations: annotations2 } = extractTextAndAnnotations(newContent);
      import_lodash.default.throttle(function() {
        (text == null ? void 0 : text.length) > 100 && user && saveData(text, annotations2, pageId, saveTextFetcher);
      }, 500)();
    }), () => {
    ...
    let timer = setTimeout(() => {
      ...
      checkunknown_default(newContent), content = generateHtmlFromTextAndAnnotations(newContent, annotations), editor == null || editor.commands.setContent(content);
    }, 100);
...
async function updateSuggestionContent(id, newValue) {
  try {
    return console.log(...oo_oo8("891852995_0", id)), await db.suggestion.update({
      where: {
        id
      },
      data: {
...
var import_react31 = require("@tiptap/react"), import_recoil11 = require("recoil");
var useEditorInstance = (content) => {
  let [selectedPost, postSelector] = (0, import_recoil11.useRecoilState)(selectedPostThread), [suggestionSelected, suggestionSelector] = (0, import_recoil11.useRecoilState)(selectedSuggestionThread), [selection, setSelectionRange] = (0, import_recoil11.useRecoilState)(selectedTextOnEditor), [openSuggestion, setOpenSuggestion] = (0, import_recoil11.useRecoilState)(openSuggestionState);
  ...
  return (0, import_react31.useEditor)(
    {
      extensions: [
        import_extension_document.default,
...
var getUserPage = async (userId, versionId) => db.userText.findUnique({
  where: { id: parseInt(versionId) }
}), getAllVersions = async (textId, order) => {
  try {
...
var import_ai2 = require("react-icons/ai"), import_io = require("react-icons/io"), import_jsx_dev_runtime25 = require("react/jsx-dev-runtime");
function TextHeader() {
  let { text } = (0, import_react32.useLoaderData)(), loc = (0, import_react32.useLocation)();
  return /* @__PURE__ */ (0, import_jsx_dev_runtime25.jsxDEV)(
    "div",
    {
      className: "bg-gray-50  flex justify-between items-center border-t ",
      style: { marginTop: 56, height: 60 },
      children: /* @__PURE__ */ (0, import_jsx_dev_runtime25.jsxDEV)("div", { className: "flex justify-between items-center lg:px-9 md:px-3 max-w-3xl w-full mx-auto", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime25.jsxDEV)(import_react32.Link, { to: "/", children: /* @__PURE__ */ (0, import_jsx_dev_runtime25.jsxDEV)(import_ai2.AiOutlineClose, { size: 30, color: "gray" }, void 0, !1, {
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime25.jsxDEV)("div", { style: { fontSize: "clamp(18px, 24px, 2.2vw)", fontWeight: "bold" }, children: text.name }, void 0, !1, {
          fileName: "app/component/Layout/TextHeader.tsx",
          lineNumber: 17,
          columnNumber: 9
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime25.jsxDEV)(import_react32.Link, { to: loc.pathname + "?with=all", children: /* @__PURE__ */ (0, import_jsx_dev_runtime25.jsxDEV)(import_io.IoIosOptions, { size: 30, color: "gray" }, void 0, !1, {
          fileName: "app/component/Layout/TextHeader.tsx",
          lineNumber: 19,
          columnNumber: 11
        }, this) }, void 0, !1, {
...
var import_react33 = require("@remix-run/react"), import_ai3 = require("react-icons/ai"), import_io2 = require("react-icons/io"), import_jsx_dev_runtime26 = require("react/jsx-dev-runtime");
function MenuHeader() {
  let [searchParams, setSearchParams] = (0, import_react33.useSearchParams)(), header = searchParams.get("with");
  return /* @__PURE__ */ (0, import_jsx_dev_runtime26.jsxDEV)("div", { className: "w-full uppercase text-gray-500 h-[60px]  bg-gray-100 flex items-center justify-between px-6", children: [
    header === "all" ? "Resources" : /* @__PURE__ */ (0, import_jsx_dev_runtime26.jsxDEV)("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime26.jsxDEV)("button", { type: "button", onClick: () => setSearchParams({ with: "all" }), children: /* @__PURE__ */ (0, import_jsx_dev_runtime26.jsxDEV)(import_io2.IoIosArrowRoundBack, { size: 30 }, void 0, !1, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime26.jsxDEV)("button", { type: "button", onClick: () => setSearchParams({}), children: /* @__PURE__ */ (0, import_jsx_dev_runtime26.jsxDEV)(import_ai3.AiOutlineCloseCircle, {}, void 0, !1, {
      fileName: "app/component/menu/MenuHeader.tsx",
      lineNumber: 21,
      columnNumber: 9
    }, this) }, void 0, !1, {
...
var import_react34 = require("@remix-run/react"), import_jsx_dev_runtime27 = require("react/jsx-dev-runtime");
function MenuHome() {
  let li_className = "hover:text-gray-500 cursor-pointer", [searchParams, setSearchParams] = (0, import_react34.useSearchParams)();
  return /* @__PURE__ */ (0, import_jsx_dev_runtime27.jsxDEV)("div", { className: "border-l p-3 flex-1", children: /* @__PURE__ */ (0, import_jsx_dev_runtime27.jsxDEV)("ul", { className: "p-2 text-gray-400 capitalize text-lg", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime27.jsxDEV)("li", { className: li_className, children: /* @__PURE__ */ (0, import_jsx_dev_runtime27.jsxDEV)("button", { type: "button", onClick: () => setSearchParams({ with: "TableOfContent" }), children: "Table of Contents" }, void 0, !1, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime27.jsxDEV)("li", { className: li_className, children: /* @__PURE__ */ (0, import_jsx_dev_runtime27.jsxDEV)("button", { type: "button", onClick: () => setSearchParams({ with: "Search" }), children: "Search in Text" }, void 0, !1, {
      fileName: "app/component/menu/MenuHome.tsx",
      lineNumber: 15,
      columnNumber: 11
    }, this) }, void 0, !1, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime27.jsxDEV)("li", { className: li_className, children: /* @__PURE__ */ (0, import_jsx_dev_runtime27.jsxDEV)("button", { type: "button", onClick: () => setSearchParams({ with: "Translations" }), children: "Translations" }, void 0, !1, {
      fileName: "app/component/menu/MenuHome.tsx",
      lineNumber: 20,
      columnNumber: 11
    }, this) }, void 0, !1, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime27.jsxDEV)("li", { className: li_className, children: /* @__PURE__ */ (0, import_jsx_dev_runtime27.jsxDEV)("button", { type: "button", onClick: () => setSearchParams({ with: "Post" }), children: "Post" }, void 0, !1, {
      fileName: "app/component/menu/MenuHome.tsx",
      lineNumber: 25,
      columnNumber: 11
    }, this) }, void 0, !1, {
...
var import_jsx_dev_runtime28 = require("react/jsx-dev-runtime"), TableOfContents = ({ editor }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime28.jsxDEV)("div", { className: "z-50 w-full bg-gray-100 p-4 dark:bg-gray-600 flex-1", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime28.jsxDEV)("div", { className: "relative", children: [
    ...
    data.versions.length > 0 && /* @__PURE__ */ (0, import_jsx_dev_runtime28.jsxDEV)("div", { className: "relative", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime28.jsxDEV)(
        "button",
        {
      ...
      isVersionOpen && data.versions.map(({ version, count }, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime28.jsxDEV)("div", { className: "mr-3", children: [
        translation[version],
        /* @__PURE__ */ (0, import_jsx_dev_runtime28.jsxDEV)("div", { className: "flex gap-2", children: new Array(count).fill(0).map((_2, index2) => {
          let textId = (0, import_react35.useLocation)().pathname.split("/")[2], page = index2 + 1;
          return /* @__PURE__ */ (0, import_jsx_dev_runtime28.jsxDEV)("div", { className: "rounded-sm bg-slate-100 p-1 shadow hover:bg-yellow-200", children: /* @__PURE__ */ (0, import_jsx_dev_runtime28.jsxDEV)(import_react35.Link, { to: `/text/${textId}/page/${page}/?version=${version}`, children: page }, void 0, !1, {
            fileName: "app/component/menu/TableOfContent.tsx",
            lineNumber: 81,
            columnNumber: 27
          }, this) }, index2 + "pages", !1, {
...
function Search() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime29.jsxDEV)("div", { children: "Search" }, void 0, !1, {
...
function Translations() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime30.jsxDEV)("div", { children: "Translations" }, void 0, !1, {
...
// app/features/PostContainer/index.tsx
var import_react43 = require("react"), import_recoil14 = require("recoil");
...
function Comments({ comments }) {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime31.jsxDEV)(import_jsx_dev_runtime31.Fragment, { children: comments.length > 0 && comments.map((comment, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime31.jsxDEV)(Comment, { comment }, comment.id, !1, {
...
var Comment = ({ comment }) => {
  ...
  let [openEditMenu, setOpenEditMenu] = (0, import_react37.useState)(!1), [edit, setEdit] = (0, import_react37.useState)(!1), [newContent, setNewContent] = (0, import_react37.useState)(comment.text), [checked, setChecked] = (0, import_react37.useState)(comment.type === "support"), { user } = (0, import_react38.useOutletContext)(), ref = (0, import_react_detect_click_outside4.useDetectClickOutside)({
    ...
    ) : console.log(...oo_oo9("1597357950_0", "cancelled"));
  }, handleSubmit = () => {
    fetcher.submit(
      {
        id: comment.id,
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime31.jsxDEV)("div", { className: `rounded-lg p-2  text-base dark:bg-gray-700 ${color}`, children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime31.jsxDEV)("div", { className: "mb-2 flex items-center justify-between", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime31.jsxDEV)("div", { className: "flex items-center", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime31.jsxDEV)("p", { className: "mr-3 inline-flex items-center text-sm text-gray-900 dark:text-white", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime31.jsxDEV)("img", { className: "mr-2 h-6 w-6 rounded-full", src: (_a = comment.author) == null ? void 0 : _a.avatarUrl, alt: "author image" }, void 0, !1, {
            fileName: "app/features/Suggestion/Comment.tsx",
            lineNumber: 77,
            columnNumber: 13
          }, this),
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime31.jsxDEV)("p", { className: "text-sm text-gray-600 dark:text-gray-400", children: time }, void 0, !1, {
          fileName: "app/features/Suggestion/Comment.tsx",
          lineNumber: 80,
          columnNumber: 11
        }, this)
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime31.jsxDEV)("div", { className: "relative ml-3", ref, children: [
          ...
          "button",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_dev_runtime31.jsxDEV)(
              "svg",
              {
                ...
                viewBox: "0 0 20 20",
                xmlns: "http://www.w3.org/2000/svg",
                children: /* @__PURE__ */ (0, import_jsx_dev_runtime31.jsxDEV)("path", { d: "M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" }, void 0, !1, {
                  fileName: "app/features/Suggestion/Comment.tsx",
                  lineNumber: 95,
                  columnNumber: 15
                }, this)
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_dev_runtime31.jsxDEV)(
              "ul",
              {
                ...
                "aria-labelledby": "dropdownMenuIconHorizontalButton",
                children: [
                  user && user.username === (comment == null ? void 0 : comment.author.username) && /* @__PURE__ */ (0, import_jsx_dev_runtime31.jsxDEV)(import_jsx_dev_runtime31.Fragment, { children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_dev_runtime31.jsxDEV)("li", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime31.jsxDEV)("div", { className: "block cursor-pointer px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white", children: "Report" }, void 0, !1, {
                    fileName: "app/features/Suggestion/Comment.tsx",
                    lineNumber: 129,
                    columnNumber: 17
                  }, this) }, void 0, !1, {
    ...
    edit ? /* @__PURE__ */ (0, import_jsx_dev_runtime31.jsxDEV)("div", { className: "flex flex-col", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime31.jsxDEV)(TextArea_default, { value: newContent, onChange: (e) => setNewContent(e.target.value) }, void 0, !1, {
        fileName: "app/features/Suggestion/Comment.tsx",
        lineNumber: 139,
        columnNumber: 11
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime31.jsxDEV)("div", { className: "mt-2 flex justify-between gap-2", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime31.jsxDEV)("div", { className: "flex-1 ", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime31.jsxDEV)("label", { htmlFor: "checkbox" + comment.id, className: "mr-2", children: "support" }, void 0, !1, {
            fileName: "app/features/Suggestion/Comment.tsx",
            lineNumber: 142,
            columnNumber: 15
          }, this),
          ...
          audioPresent && /* @__PURE__ */ (0, import_jsx_dev_runtime31.jsxDEV)(import_AudioPlayer.default, { src: comment.audioUrl }, void 0, !1, {
            fileName: "app/features/Suggestion/Comment.tsx",
            lineNumber: 152,
            columnNumber: 32
          }, this)
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime31.jsxDEV)(Button, { onClick: handleSubmit, label: "submit", type: "submit" }, void 0, !1, {
          fileName: "app/features/Suggestion/Comment.tsx",
          lineNumber: 154,
          columnNumber: 13
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime31.jsxDEV)(Button, { onClick: () => setEdit(!1), label: "cancel", type: "reset" }, void 0, !1, {
          fileName: "app/features/Suggestion/Comment.tsx",
          lineNumber: 155,
          columnNumber: 13
        }, this)
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime31.jsxDEV)("p", { className: "text-gray-500 dark:text-gray-400", children: comment.text }, void 0, !1, {
        fileName: "app/features/Suggestion/Comment.tsx",
        lineNumber: 162,
        columnNumber: 11
      }, this)
...
function Suggestion2({ editor, suggest, optimistic = !1, count }) {
  ...
  function deleteSuggestion2(id) {
    ...
    )) : console.log(...oo_oo10("3144943058_0", "cancelled"));
  }
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("div", { className: `${deleteFetcher.formData && "hidden"} p-3 `, children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("div", { className: "relative mb-2 flex justify-between", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("div", { className: "  flex items-center gap-3", children: [
        suggest.user.length && /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)(import_jsx_dev_runtime32.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("div", { className: "flex -space-x-4", children: (_c = suggest.user) == null ? void 0 : _c.map((item) => /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)(
            "img",
            {
              title: item.username,
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("div", { className: "flex gap-1 text-base font-medium leading-tight text-gray-900 dark:text-gray-200 ", children: (_d = suggest.user) == null ? void 0 : _d.map((item, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("div", { className: "text-md capitalize", children: [
            checkPendetaName(item.username),
            index !== suggest.user.length - 1 && /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("span", { children: " | " }, void 0, !1, {
              fileName: "app/features/Suggestion/Suggestion.tsx",
              lineNumber: 116,
              columnNumber: 59
            }, this)
        ...
        suggest.oldValue && /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("p", { className: "text-sm text-gray-600 dark:text-gray-400", children: time }, void 0, !1, {
          fileName: "app/features/Suggestion/Suggestion.tsx",
          lineNumber: 122,
          columnNumber: 32
        }, this)
        ...
        "button",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)(
            "svg",
            {
              ...
              viewBox: "0 0 20 20",
              xmlns: "http://www.w3.org/2000/svg",
              children: /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("path", { d: "M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" }, void 0, !1, {
                fileName: "app/features/Suggestion/Suggestion.tsx",
                lineNumber: 136,
                columnNumber: 13
              }, this)
        ...
        "div",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)(
            "ul",
            {
              ...
              "aria-labelledby": "dropdownMenuIconHorizontalButton",
              children: [
                user && suggest.user.length && ((_e = suggest.user) == null ? void 0 : _e.some((e) => e.username === user.username)) && /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)(import_jsx_dev_runtime32.Fragment, { children: [
                ...
                /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("li", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("div", { className: "block cursor-pointer px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white", children: "Report" }, void 0, !1, {
                  fileName: "app/features/Suggestion/Suggestion.tsx",
                  lineNumber: 171,
                  columnNumber: 15
                }, this) }, void 0, !1, {
    ...
    suggest.oldValue ? /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("div", { className: " mb-3 w-full text-base leading-normal text-black", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("span", { className: "text-sm font-bold", children: "Replace :" }, void 0, !1, {
        fileName: "app/features/Suggestion/Suggestion.tsx",
        lineNumber: 180,
        columnNumber: 11
      }, this),
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("span", { className: "text-sm font-bold", children: " with :" }, void 0, !1, {
        fileName: "app/features/Suggestion/Suggestion.tsx",
        lineNumber: 190,
        columnNumber: 11
      }, this),
      openEdit ? /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)(
        editFetcher.Form,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("input", { name: "id", type: "text", value: suggest.id, hidden: !0 }, void 0, !1, {
              fileName: "app/features/Suggestion/Suggestion.tsx",
              lineNumber: 204,
              columnNumber: 15
            }, this),
            /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)(Button, { label: editFetcher.state === "submitting" ? "saving" : "confirm", type: "submit" }, void 0, !1, {
              fileName: "app/features/Suggestion/Suggestion.tsx",
              lineNumber: 205,
              columnNumber: 15
            }, this),
            /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)(Button, { label: "cancel", type: "reset", onClick: () => setOpenEdit(!1) }, void 0, !1, {
              fileName: "app/features/Suggestion/Suggestion.tsx",
              lineNumber: 206,
              columnNumber: 15
            }, this)
      ...
      lineNumber: 179,
      columnNumber: 9
    }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("div", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)(
      "span",
      {
        onClick: () => {
          text.author.username === user.username && replaceMarkContent(editor, suggest.threadId, suggest.newValue);
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("div", { className: "mb-2", children: (suggest == null ? void 0 : suggest.audioUrl) && suggest.audioUrl !== "" && /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)(import_AudioPlayer.default, { src: suggest == null ? void 0 : suggest.audioUrl }, void 0, !1, {
      fileName: "app/features/Suggestion/Suggestion.tsx",
      lineNumber: 235,
      columnNumber: 58
    }, this) }, void 0, !1, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("div", { className: "flex justify-between", children: optimistic ? /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("div", { className: "text-light text-sm ", children: "saving" }, void 0, !1, {
      fileName: "app/features/Suggestion/Suggestion.tsx",
      lineNumber: 239,
      columnNumber: 11
    }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)(import_jsx_dev_runtime32.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("div", { className: "flex gap-4", children: /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)(
        "button",
        {
          ...
          onAnimationEnd: () => setEffect(!1),
          children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("svg", { width: "14", height: "14", viewBox: "0 0 14 14", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)(
              "path",
              {
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("div", { className: "  text-sm font-medium leading-tight text-gray-500 dark:text-gray-100", children: likeCount > 0 && likeCount }, void 0, !1, {
              fileName: "app/features/Suggestion/Suggestion.tsx",
              lineNumber: 255,
              columnNumber: 17
            }, this)
      ...
      user && /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("button", { className: "text-sm font-medium leading-tight text-gray-500 dark:text-gray-100", children: openComment ? "close" : "Comment" }, void 0, !1, {
              fileName: "app/features/Suggestion/Suggestion.tsx",
              lineNumber: 274,
              columnNumber: 17
            }, this)
    ...
    openComment && /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)(
      CommentSection,
      {
        id: suggest.id,
        setOpenComment,
...
function CommentSection({ id, setOpenComment, comments, type }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("div", { className: "mt-2 flex justify-between gap-2 rounded  bg-gray-100 pt-1", children: /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("div", { className: "flex flex-1 flex-col gap-2 ", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)(
      TextArea_default,
      {
    ...
    audio.tempUrl !== "" ? /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)(import_jsx_dev_runtime32.Fragment, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("div", { className: "my-2 flex w-full items-center gap-3", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)(import_AudioPlayer.default, { src: audio.tempUrl }, void 0, !1, {
        fileName: "app/features/Suggestion/Suggestion.tsx",
        lineNumber: 339,
        columnNumber: 15
      }, this),
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("div", { className: "flex justify-between", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("div", { className: "flex justify-end gap-2", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)(Button, { label: "cancel", type: "reset", onClick: () => setOpenComment(!1) }, void 0, !1, {
          fileName: "app/features/Suggestion/Suggestion.tsx",
          lineNumber: 362,
          columnNumber: 13
        }, this)
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)(Comments, { comments }, void 0, !1, {
      fileName: "app/features/Suggestion/Suggestion.tsx",
      lineNumber: 365,
      columnNumber: 9
    }, this)
...
function Suggestions({ editor, suggestions }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime33.jsxDEV)(
    "div",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_dev_runtime33.jsxDEV)("div", { className: "flex flex-col  gap-2 ", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime33.jsxDEV)("div", { className: "flex justify-between", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime33.jsxDEV)("h2", { className: "text-lg font-bold text-gray-900 dark:text-white lg:text-2xl", children: "Suggestion" }, void 0, !1, {
            fileName: "app/features/Suggestion/SuggestionContainer.tsx",
            lineNumber: 25,
            columnNumber: 11
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime33.jsxDEV)("button", { onClick: handleClose, className: "mr-2", children: /* @__PURE__ */ (0, import_jsx_dev_runtime33.jsxDEV)(import_gr3.GrClose, { size: 14, className: "cursor-pointer text-gray-500" }, void 0, !1, {
            fileName: "app/features/Suggestion/SuggestionContainer.tsx",
            lineNumber: 27,
            columnNumber: 13
          }, this) }, void 0, !1, {
        ...
        groupedSuggestion.map((suggest) => /* @__PURE__ */ (0, import_jsx_dev_runtime33.jsxDEV)(
          Suggestion2,
          {
            optimistic: !1,
            editor,
...
function SuggestionForm({ editor, page }) {
  ...
  return user ? isPosting ? /* @__PURE__ */ (0, import_jsx_dev_runtime34.jsxDEV)("div", { className: "bg-slate-50 p-2 shadow-md dark:bg-gray-700 ", children: /* @__PURE__ */ (0, import_jsx_dev_runtime34.jsxDEV)("div", { className: "flex flex-col gap-2 ", children: /* @__PURE__ */ (0, import_jsx_dev_runtime34.jsxDEV)(
    Suggestion2,
    {
      editor: null,
      optimistic: !0,
    ...
    lineNumber: 88,
    columnNumber: 7
  }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime34.jsxDEV)("div", { className: "mb-2 ml-2 bg-slate-50 p-2 shadow-md dark:bg-gray-700", children: [
    ((_e = addSuggestion.data) == null ? void 0 : _e.message) && /* @__PURE__ */ (0, import_jsx_dev_runtime34.jsxDEV)("div", { className: "font-sm text-red-500", children: (_f = addSuggestion.data) == null ? void 0 : _f.message }, void 0, !1, {
      fileName: "app/features/Suggestion/SuggestionForm.tsx",
      lineNumber: 114,
      columnNumber: 39
    }, this),
    ...
    audio.tempUrl !== "" ? /* @__PURE__ */ (0, import_jsx_dev_runtime34.jsxDEV)(import_jsx_dev_runtime34.Fragment, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime34.jsxDEV)("div", { className: "mt-2 flex w-full items-center gap-3", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime34.jsxDEV)(import_AudioPlayer.default, { src: audio.tempUrl }, void 0, !1, {
        fileName: "app/features/Suggestion/SuggestionForm.tsx",
        lineNumber: 124,
        columnNumber: 13
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime34.jsxDEV)("div", { onClick: () => setAudio({ tempUrl: "", blob: null }), children: /* @__PURE__ */ (0, import_jsx_dev_runtime34.jsxDEV)("svg", { width: "20", height: "20", viewBox: "0 0 20 20", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ (0, import_jsx_dev_runtime34.jsxDEV)(
        "path",
        {
          fillRule: "evenodd",
          clipRule: "evenodd",
    ...
    error && /* @__PURE__ */ (0, import_jsx_dev_runtime34.jsxDEV)("div", { className: "text-red-400", children: error }, void 0, !1, {
      fileName: "app/features/Suggestion/SuggestionForm.tsx",
      lineNumber: 138,
      columnNumber: 17
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime34.jsxDEV)("div", { className: "flex justify-between", children: [
      audio.tempUrl === "" ? /* @__PURE__ */ (0, import_jsx_dev_runtime34.jsxDEV)(import_AudioRecorder.default, { setAudio }, void 0, !1, {
        fileName: "app/features/Suggestion/SuggestionForm.tsx",
        lineNumber: 140,
        columnNumber: 33
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime34.jsxDEV)("div", { className: "mt-3 flex justify-end gap-2", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime34.jsxDEV)(
          Button,
          {
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime34.jsxDEV)(Button, { onClick: handleSuggestionCancel, type: "reset", label: "cancel" }, void 0, !1, {
          fileName: "app/features/Suggestion/SuggestionForm.tsx",
          lineNumber: 148,
          columnNumber: 11
        }, this)
...
function PostContainer2({ editor, createPost: createPost3, isMobile: isMobile2 }) {
  let [suggestionSelected, suggestionSelector] = (0, import_recoil14.useRecoilState)(selectedSuggestionThread), [openSuggestion, setOpenSuggestion] = (0, import_recoil14.useRecoilState)(openSuggestionState), [selectedPost, postSelector] = (0, import_recoil14.useRecoilState)(selectedPostThread), [selection] = (0, import_recoil14.useRecoilState)(selectedTextOnEditor), data = (0, import_react44.useLoaderData)(), user = data == null ? void 0 : data.user, page = data.page;
  return isMobile2 ? /* @__PURE__ */ (0, import_jsx_dev_runtime35.jsxDEV)(import_jsx_dev_runtime35.Fragment, { children: suggestionSelected != null && suggestionSelected.id || openSuggestion ? /* @__PURE__ */ (0, import_jsx_dev_runtime35.jsxDEV)("div", { className: "absolute bottom-0 w-full bg-white max-h-[50dvh] overflow-y-scroll ", children: /* @__PURE__ */ (0, import_jsx_dev_runtime35.jsxDEV)(
    SuggestionSidebar,
    {
    ...
    !1,
    {
      fileName: "app/features/PostContainer/index.tsx",
      lineNumber: 29,
      columnNumber: 13
    },
    this
    ...
    lineNumber: 28,
    columnNumber: 11
  }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime35.jsxDEV)("div", { className: "max-h-[50dvh] overflow-y-scroll]", children: /* @__PURE__ */ (0, import_jsx_dev_runtime35.jsxDEV)(
    PostSidebar,
    {
      page,
      user,
    ...
    "div",
    {
      ...
      id: "postContent",
      children: suggestionSelected != null && suggestionSelected.id || openSuggestion ? /* @__PURE__ */ (0, import_jsx_dev_runtime35.jsxDEV)(
        SuggestionSidebar,
        {
          suggestions: data.suggestions,
          suggestionSelected,
...
var PostContainer_default = PostContainer2;
...
function SuggestionSidebar(props) {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime35.jsxDEV)("div", { className: "z-20 w-full", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime35.jsxDEV)(SuggestionForm, { editor: props.editor, page: props.page }, void 0, !1, {
      fileName: "app/features/PostContainer/index.tsx",
      lineNumber: 110,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime35.jsxDEV)(import_react43.Suspense, { fallback: /* @__PURE__ */ (0, import_jsx_dev_runtime35.jsxDEV)("div", { children: "loading" }, void 0, !1, {
      fileName: "app/features/PostContainer/index.tsx",
      lineNumber: 111,
      columnNumber: 27
    }, this), children: /* @__PURE__ */ (0, import_jsx_dev_runtime35.jsxDEV)(import_react44.Await, { resolve: props.suggestions, children: (data) => /* @__PURE__ */ (0, import_jsx_dev_runtime35.jsxDEV)(SuggestionContainer_default, { editor: props.editor, suggestions: data }, void 0, !1, {
      fileName: "app/features/PostContainer/index.tsx",
      lineNumber: 113,
      columnNumber: 22
    }, this) }, void 0, !1, {
...
function Post2({ editor }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime36.jsxDEV)(PostContainer_default, { editor, createPost: createPost3, isMobile: !1 }, void 0, !1, {
...
function Menu({ editor }) {
  let [searchParams] = (0, import_react45.useSearchParams)(), menu = searchParams.get("with");
  return menu ? /* @__PURE__ */ (0, import_jsx_dev_runtime37.jsxDEV)("div", { className: "w-full flex flex-col max-w-[30%]", style: { marginTop: 56 }, children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime37.jsxDEV)(MenuHeader_default, {}, void 0, !1, {
      fileName: "app/component/menu/Menu.tsx",
      lineNumber: 17,
      columnNumber: 7
    }, this),
    menu === "all" && /* @__PURE__ */ (0, import_jsx_dev_runtime37.jsxDEV)(MenuHome_default, {}, void 0, !1, {
      fileName: "app/component/menu/Menu.tsx",
      lineNumber: 18,
      columnNumber: 26
    }, this),
    menu === "TableOfContent" && /* @__PURE__ */ (0, import_jsx_dev_runtime37.jsxDEV)(TableOfContent_default, { editor: null }, void 0, !1, {
      fileName: "app/component/menu/Menu.tsx",
      lineNumber: 19,
      columnNumber: 37
    }, this),
    menu === "Search" && /* @__PURE__ */ (0, import_jsx_dev_runtime37.jsxDEV)(Search_default, {}, void 0, !1, {
      fileName: "app/component/menu/Menu.tsx",
      lineNumber: 20,
      columnNumber: 29
    }, this),
    menu === "Translations" && /* @__PURE__ */ (0, import_jsx_dev_runtime37.jsxDEV)(Translations_default, {}, void 0, !1, {
      fileName: "app/component/menu/Menu.tsx",
      lineNumber: 21,
      columnNumber: 35
    }, this),
    menu === "Post" && /* @__PURE__ */ (0, import_jsx_dev_runtime37.jsxDEV)(Post_default2, { editor }, void 0, !1, {
      fileName: "app/component/menu/Menu.tsx",
      lineNumber: 22,
      columnNumber: 27
    }, this)
...
// app/routes/text.$textId.page.$pageId.tsx
var import_jsx_dev_runtime38 = require("react/jsx-dev-runtime"), loader3 = async ({ request, params }) => {
  ...
  let text = await getText(textId), page = await getPage(parseInt(textId), parseInt(order), version), user = await getUserSession(request), suggestions = await findAllSuggestionByPageId(page == null ? void 0 : page.id), user_versions = await getAllVersions(textId, order), annotations = await getAnnotations(page == null ? void 0 : page.id);
...
function Page() {
  let data = (0, import_react46.useLoaderData)(), { page } = data, [suggestionSelected] = (0, import_recoil15.useRecoilState)(selectedSuggestionThread), [openSuggestion] = (0, import_recoil15.useRecoilState)(openSuggestionState), [selectedPost, postSelector] = (0, import_recoil15.useRecoilState)(selectedPostThread), [selection] = (0, import_recoil15.useRecoilState)(selectedTextOnEditor), [showPostSide, setShowPostSide] = (0, import_recoil15.useRecoilState)(showSidebar), saveTextFetcher = (0, import_react46.useFetcher)(), editor = useEditorInstance_default(page == null ? void 0 : page.content);
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime38.jsxDEV)(import_jsx_dev_runtime38.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime38.jsxDEV)(Header_default, { editor }, void 0, !1, {
      fileName: "app/routes/text.$textId.page.$pageId.tsx",
      lineNumber: 88,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime38.jsxDEV)("div", { className: "flex w-full", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime38.jsxDEV)("div", { className: "flex-1", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime38.jsxDEV)(TextHeader_default, {}, void 0, !1, {
          fileName: "app/routes/text.$textId.page.$pageId.tsx",
          lineNumber: 91,
          columnNumber: 11
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime38.jsxDEV)("div", { className: "relative flex justify-between gap-4 transition-all", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime38.jsxDEV)(import_react_spinner_overlay.CircleSpinnerOverlay, { message: "updating text", loading: saveTextFetcher.state !== "idle" }, void 0, !1, {
            fileName: "app/routes/text.$textId.page.$pageId.tsx",
            lineNumber: 93,
            columnNumber: 13
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime38.jsxDEV)("div", { className: "w-full flex gap-2", children: /* @__PURE__ */ (0, import_jsx_dev_runtime38.jsxDEV)(
            "div",
            {
              className: `${withImage ? "w-full" : "max-w-3xl"} justify-self-center p-2 dark:bg-gray-800 mx-auto`,
              id: "textEditorContainer",
              children: editor && /* @__PURE__ */ (0, import_jsx_dev_runtime38.jsxDEV)(
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime38.jsxDEV)(Menu_default, { editor }, void 0, !1, {
        fileName: "app/routes/text.$textId.page.$pageId.tsx",
        lineNumber: 119,
        columnNumber: 9
      }, this)
...
// app/routes/version.$versionId.tsx
var version_versionId_exports = {};
__export(version_versionId_exports, {
  default: () => version_versionId_default,
  loader: () => loader4
});
...
var import_jsx_dev_runtime39 = require("react/jsx-dev-runtime"), ToolButton = ({ children, isActive, ...props }) => /* @__PURE__ */ (0, import_jsx_dev_runtime39.jsxDEV)(
  "button",
  {
    ...props,
...
function Tools({ editor }) {
  return editor ? /* @__PURE__ */ (0, import_jsx_dev_runtime40.jsxDEV)("div", { className: "flex flex-wrap justify-between bg-gray-200 border-2", children: /* @__PURE__ */ (0, import_jsx_dev_runtime40.jsxDEV)("div", { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime40.jsxDEV)(ToolButton_default, { onClick: () => editor.chain().focus().undo().run(), disabled: !editor.can().undo(), children: "undo" }, void 0, !1, {
      fileName: "app/features/Editor/tiptap/component/Tools.tsx",
      lineNumber: 33,
      columnNumber: 9
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime40.jsxDEV)(ToolButton_default, { onClick: () => editor.chain().focus().redo().run(), disabled: !editor.can().redo(), children: "redo" }, void 0, !1, {
      fileName: "app/features/Editor/tiptap/component/Tools.tsx",
      lineNumber: 36,
      columnNumber: 9
    }, this)
...
function SourceEditor({ content }) {
  let editor = useEditorInstance_default(content);
  return (0, import_react48.useEffect)(() => {
    let timer = setTimeout(() => {
      let newContent = content.replace(/[\r\n]+/g, "<p/><p>");
      content = generateHtmlFromTextAndAnnotations(newContent, []), editor == null || editor.commands.setContent(content);
    }, 100);
    return () => {
      clearTimeout(timer);
    };
  }, [content, editor]), /* @__PURE__ */ (0, import_jsx_dev_runtime41.jsxDEV)(import_jsx_dev_runtime41.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime41.jsxDEV)(Tools_default, { editor }, void 0, !1, {
      fileName: "app/features/Translation/SourceEditor.tsx",
      lineNumber: 26,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime41.jsxDEV)(import_react49.EditorContent, { editor }, void 0, !1, {
      fileName: "app/features/Translation/SourceEditor.tsx",
      lineNumber: 27,
      columnNumber: 7
    }, this)
...
// app/routes/version.$versionId.tsx
var import_jsx_dev_runtime42 = require("react/jsx-dev-runtime"), loader4 = async ({ request, params }) => {
  let url = new URL(request.url), versionId = params.versionId, user = await getUserSession(request);
  return { source: await getUserPage(user.id, versionId) };
};
function Translation2() {
  let { source } = (0, import_react50.useLoaderData)(), editor = useEditorInstance_default(source == null ? void 0 : source.id, source == null ? void 0 : source.order);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime42.jsxDEV)(import_jsx_dev_runtime42.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime42.jsxDEV)(Header_default, { editor }, void 0, !1, {
      fileName: "app/routes/version.$versionId.tsx",
      lineNumber: 26,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime42.jsxDEV)(
      "div",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_dev_runtime42.jsxDEV)("div", { className: "flex p-2 border-2 xl:mx-10 h-[80vh]", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime42.jsxDEV)("div", { className: "w-[50%]", children: /* @__PURE__ */ (0, import_jsx_dev_runtime42.jsxDEV)(SourceEditor_default, { content: source == null ? void 0 : source.content }, void 0, !1, {
            fileName: "app/routes/version.$versionId.tsx",
            lineNumber: 34,
            columnNumber: 13
          }, this) }, void 0, !1, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime42.jsxDEV)("div", { className: "w-[50%]", children: "translation" }, void 0, !1, {
            fileName: "app/routes/version.$versionId.tsx",
            lineNumber: 36,
            columnNumber: 11
          }, this)
...
var version_versionId_default = Translation2;
...
// app/routes/version.create.tsx
var version_create_exports = {};
__export(version_create_exports, {
  default: () => version_create_default,
  loader: () => loader7
});
var import_react51 = require("@remix-run/react");

// app/model/translation.ts
var createUserPage = async (textId, order, user) => {
  let text = await getText(textId), page = await getPage(textId, parseInt(order), {}), check = await db.userText.findFirst({
    where: {
      textId: parseInt(text == null ? void 0 : text.id),
      name: text.name,
      userId: user.id,
      order: parseInt(order)
    }
  ...
  try {
    return await db.userText.create({
      data: {
        content: page == null ? void 0 : page.content,
        name: text == null ? void 0 : text.name,
        textId: parseInt(text == null ? void 0 : text.id),
        userId: user.id,
        order: parseInt(order)
      }
    ...
    console.log(...oo_oo14("778731868_0", e));
  }
};
function oo_cm14() {
  try {
...
// app/routes/version.create.tsx
var import_jsx_dev_runtime43 = require("react/jsx-dev-runtime"), loader7 = async ({ request, params }) => {
  let url = new URL(request.url), textId = url.searchParams.get("text"), pageId = url.searchParams.get("page"), user = await getUserSession(request);
  return { source: await createUserPage(textId, pageId, user) };
};
function Translation3() {
  let { source } = (0, import_react51.useLoaderData)(), editor = useEditorInstance_default(source == null ? void 0 : source.id, source == null ? void 0 : source.order);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime43.jsxDEV)(import_jsx_dev_runtime43.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime43.jsxDEV)(Header_default, { editor }, void 0, !1, {
      fileName: "app/routes/version.create.tsx",
      lineNumber: 25,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime43.jsxDEV)(
      "div",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_dev_runtime43.jsxDEV)("div", { className: "flex p-2 border-2 xl:mx-10", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime43.jsxDEV)("div", { className: "max-w-2xl", children: source.content }, void 0, !1, {
            fileName: "app/routes/version.create.tsx",
            lineNumber: 32,
            columnNumber: 11
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime43.jsxDEV)("div", { className: "max-w-2xl", children: "translation" }, void 0, !1, {
            fileName: "app/routes/version.create.tsx",
            lineNumber: 33,
            columnNumber: 11
          }, this)
...
var version_create_default = Translation3;
...
var action6 = async ({ request }) => {
  ...
  try {
    ...
    if (request.method === "PATCH") {
      let formData = await request.formData(), user2 = await getUserSession(request), Obj = Object.fromEntries(formData), action9 = Obj.action;
      if (action9 === "like") {
...
var action7 = async ({ request }) => {
  ...
  if (request.method === "PATCH") {
    let formData = await (0, import_node9.unstable_parseMultipartFormData)(request, uploadHandler), action9 = formData.get("action");
    if (action9 === "like") {
...
var loader10 = async ({ request }) => {
  ...
  if (request.method === "POST") {
    let user = await getUserSession(request), newContent = data.get("content"), annotations = data.get("annotations"), pageId = data.get("pageId");
    try {
      let page_return = await updatePage(pageId, newContent), annotation_return = await updateAnnotations(pageId, annotations);
      return await trigetPusherUpdate_server_default(user, pageId), { page_return, annotation_return };
    } catch {
      return !1;
    }
  }
...
var import_react52 = require("@remix-run/react"), import_flowbite_react2 = require("flowbite-react");
...
var import_jsx_dev_runtime44 = require("react/jsx-dev-runtime"), PartnerSection = () => /* @__PURE__ */ (0, import_jsx_dev_runtime44.jsxDEV)("div", { className: "mb-10", children: /* @__PURE__ */ (0, import_jsx_dev_runtime44.jsxDEV)("div", { className: "container mx-auto", children: /* @__PURE__ */ (0, import_jsx_dev_runtime44.jsxDEV)("div", { className: "flex items-center justify-center ", children: /* @__PURE__ */ (0, import_jsx_dev_runtime44.jsxDEV)("a", { href: "https://indrajala.org.tw/", target: "_blank", rel: "noreferrer", children: /* @__PURE__ */ (0, import_jsx_dev_runtime44.jsxDEV)(
  "img",
  {
...
function FooterContainer() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime45.jsxDEV)("footer", { className: "absolute bottom-0 w-full  ", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime45.jsxDEV)(Partner_default, {}, void 0, !1, {
      fileName: "app/component/Layout/Footer.tsx",
      lineNumber: 21,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime45.jsxDEV)("div", { className: "mx-auto w-full ", children: /* @__PURE__ */ (0, import_jsx_dev_runtime45.jsxDEV)("div", { className: " px-4 py-6 dark:bg-gray-700 md:flex md:items-center md:justify-between", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime45.jsxDEV)("span", { className: "text-sm text-gray-500 dark:text-gray-300 sm:text-center" }, void 0, !1, {
        fileName: "app/component/Layout/Footer.tsx",
        lineNumber: 25,
        columnNumber: 11
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime45.jsxDEV)("div", { className: "mt-4 flex space-x-6 sm:justify-center md:mt-0", children: [
        {
      ...
      ].map((item, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime45.jsxDEV)(
        "a",
        {
          href: item.link,
          ...
          target: "_blank",
          children: [
            typeof item.logo == "string" ? /* @__PURE__ */ (0, import_jsx_dev_runtime45.jsxDEV)("img", { src: item.logo, className: "h-4 w-4", alt: "openpecha" }, void 0, !1, {
              fileName: "app/component/Layout/Footer.tsx",
              lineNumber: 36,
              columnNumber: 21
            }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime45.jsxDEV)(item.logo, {}, void 0, !1, {
              fileName: "app/component/Layout/Footer.tsx",
              lineNumber: 38,
              columnNumber: 21
            }, this),
            /* @__PURE__ */ (0, import_jsx_dev_runtime45.jsxDEV)("span", { className: "sr-only", children: "page links" }, void 0, !1, {
              fileName: "app/component/Layout/Footer.tsx",
              lineNumber: 40,
              columnNumber: 19
            }, this)
...
// app/routes/_index.tsx
var import_jsx_dev_runtime46 = require("react/jsx-dev-runtime"), loader11 = async ({ request }) => {
  var _a;
...
function Index() {
  var _a, _b;
  let data = (0, import_react53.useLoaderData)(), navigation = (0, import_react53.useNavigation)(), [params] = (0, import_react52.useSearchParams)(), [searchInput, setSearchInput] = (0, import_react54.useState)(""), translation = uselitteraTranlation();
  ...
  return lists != null && lists.message ? /* @__PURE__ */ (0, import_jsx_dev_runtime46.jsxDEV)("div", { className: "text-red-400", children: lists == null ? void 0 : lists.message }, void 0, !1, {
    ...
    import_framer_motion2.motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime46.jsxDEV)("div", { className: " mx-auto max-w-2xl ", style: { paddingTop: 56 }, children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime46.jsxDEV)("div", { className: "flex w-full flex-col items-center justify-center  px-3 pt-24 md:px-1.5  ", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime46.jsxDEV)(import_react52.Form, { method: "GET", className: "mb-3 w-full max-w-2xl", children: /* @__PURE__ */ (0, import_jsx_dev_runtime46.jsxDEV)("div", { className: "relative flex w-full space-x-3 ", children: [
              /* @__PURE__ */ (0, import_jsx_dev_runtime46.jsxDEV)(
                import_flowbite_react2.TextInput,
                {
                  ...
                  icon: () => /* @__PURE__ */ (0, import_jsx_dev_runtime46.jsxDEV)("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ (0, import_jsx_dev_runtime46.jsxDEV)(
                    "path",
                    {
              ...
              /* @__PURE__ */ (0, import_jsx_dev_runtime46.jsxDEV)(import_flowbite_react2.Button, { type: "submit", className: "h-full bg-green-400 text-white", color: "#1C64F2", size: "lg", children: translation.searchText }, void 0, !1, {
                fileName: "app/routes/_index.tsx",
                lineNumber: 118,
                columnNumber: 15
              }, this)
            ...
            (data == null ? void 0 : data.latestTexts) && /* @__PURE__ */ (0, import_jsx_dev_runtime46.jsxDEV)(import_jsx_dev_runtime46.Fragment, { children: [
              data.latestTexts.list.map((text) => {
                ...
                return /* @__PURE__ */ (0, import_jsx_dev_runtime46.jsxDEV)("div", { className: "flex w-full justify-between border-b dark:border-gray-700", children: [
                  /* @__PURE__ */ (0, import_jsx_dev_runtime46.jsxDEV)("div", { className: "flex items-center gap-1 px-4 py-4", style: { fontFamily: "monlam" }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime46.jsxDEV)(import_react52.Link, { to: url, children: text.name }, void 0, !1, {
                    fileName: "app/routes/_index.tsx",
                    lineNumber: 133,
                    columnNumber: 23
                  }, this) }, void 0, !1, {
                  ...
                  /* @__PURE__ */ (0, import_jsx_dev_runtime46.jsxDEV)("div", { className: "flex gap-2 px-4 py-4 font-light text-gray-300", children: isVersionAvailable ? /* @__PURE__ */ (0, import_jsx_dev_runtime46.jsxDEV)(import_jsx_dev_runtime46.Fragment, { children: Object.keys(groupedData).map((key) => {
                    ...
                    lineNumber: 140,
                    columnNumber: 27
                  }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime46.jsxDEV)(import_jsx_dev_runtime46.Fragment, {}, void 0, !1, {
                    fileName: "app/routes/_index.tsx",
                    lineNumber: 138,
                    columnNumber: 27
                  }, this) }, void 0, !1, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime46.jsxDEV)("div", { className: "inline-flex  w-full flex-col items-center justify-start space-y-3.5 py-10", children: [
            isLoading && /* @__PURE__ */ (0, import_jsx_dev_runtime46.jsxDEV)(Skeleton, { height: 125, number: 3 }, void 0, !1, {
              fileName: "app/routes/_index.tsx",
              lineNumber: 170,
              columnNumber: 25
            }, this),
            lists && !isLoading && /* @__PURE__ */ (0, import_jsx_dev_runtime46.jsxDEV)(import_jsx_dev_runtime46.Fragment, { children: [
              lists.length === 0 && /* @__PURE__ */ (0, import_jsx_dev_runtime46.jsxDEV)("div", { className: "text-xl font-extrabold capitalize text-gray-300 font-Inter leading-[150%]", children: "No result found" }, void 0, !1, {
                fileName: "app/routes/_index.tsx",
                lineNumber: 175,
                columnNumber: 17
              }, this),
                ...
                (list, index) => {
                  ...
                  return /* @__PURE__ */ (0, import_jsx_dev_runtime46.jsxDEV)(
                    import_react52.Link,
                    {
                      ...
                      prefetch: "intent",
                      children: /* @__PURE__ */ (0, import_jsx_dev_runtime46.jsxDEV)(import_flowbite_react2.Card, { className: "dark:bg-gray-500 font-monlam", children: [
                        /* @__PURE__ */ (0, import_jsx_dev_runtime46.jsxDEV)("div", { className: "text-xl", children: result.name }, void 0, !1, {
                          fileName: "app/routes/_index.tsx",
                          lineNumber: 196,
                          columnNumber: 25
                        }, this),
                        /* @__PURE__ */ (0, import_jsx_dev_runtime46.jsxDEV)("div", { className: "flex flex-wrap justify-between text-sm", children: [
                          result && result[1],
                          /* @__PURE__ */ (0, import_jsx_dev_runtime46.jsxDEV)("div", { className: "text-sm text-gray-400", children: [
                            result.total,
                            " matches"
                          ] }, void 0, !0, {
                            fileName: "app/routes/_index.tsx",
        ...
        !lists && !isLoading && /* @__PURE__ */ (0, import_jsx_dev_runtime46.jsxDEV)(import_jsx_dev_runtime46.Fragment, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime46.jsxDEV)(FooterContainer, {}, void 0, !1, {
          fileName: "app/routes/_index.tsx",
          lineNumber: 212,
          columnNumber: 11
        }, this) }, void 0, !1, {
    ...
    (0, import_react53.useLocation)().pathname,
    !0,
    {
      fileName: "app/routes/_index.tsx",
      lineNumber: 84,
...
function List() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime47.jsxDEV)("div", { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime47.jsxDEV)("div", { className: "h-20" }, void 0, !1, {
      fileName: "app/routes/list.tsx",
      lineNumber: 51,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime47.jsxDEV)("table", { className: "mx-auto w-full max-w-4xl text-left text-sm text-gray-500 dark:text-gray-400", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime47.jsxDEV)("thead", { className: "border-b-2 border-gray-100 text-xs uppercase text-gray-700 dark:bg-gray-700 dark:text-gray-400", children: /* @__PURE__ */ (0, import_jsx_dev_runtime47.jsxDEV)("tr", { children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime47.jsxDEV)("th", { scope: "col", className: "px-4 py-4", children: "Title" }, void 0, !1, {
          fileName: "app/routes/list.tsx",
          lineNumber: 56,
          columnNumber: 13
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime47.jsxDEV)("th", { scope: "col", className: "px-4 py-4", children: "Total page" }, void 0, !1, {
          fileName: "app/routes/list.tsx",
          lineNumber: 59,
          columnNumber: 13
        }, this)
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime47.jsxDEV)("tbody", { children: currentTexts.map((text) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_dev_runtime47.jsxDEV)(
          "tr",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_dev_runtime47.jsxDEV)("th", { scope: "col", className: "flex items-center gap-1 px-4 py-4", style: { fontFamily: "monlam" }, children: [
                ...
                /* @__PURE__ */ (0, import_jsx_dev_runtime47.jsxDEV)(import_react55.Link, { to: url, children: text.name }, void 0, !1, {
                  fileName: "app/routes/list.tsx",
                  lineNumber: 82,
                  columnNumber: 19
                }, this)
              ...
              /* @__PURE__ */ (0, import_jsx_dev_runtime47.jsxDEV)("td", { scope: "col", className: " px-4 py-4", children: isVersionAvailable ? /* @__PURE__ */ (0, import_jsx_dev_runtime47.jsxDEV)("div", { className: "flex gap-2", children: Object.keys(groupedData).map((key) => {
                let urlversion = url + "?version=" + key;
                return /* @__PURE__ */ (0, import_jsx_dev_runtime47.jsxDEV)(
                  import_react55.Link,
                  {
                ...
                lineNumber: 95,
                columnNumber: 21
              }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime47.jsxDEV)("div", { className: "flex gap-2", children: [
                /* @__PURE__ */ (0, import_jsx_dev_runtime47.jsxDEV)("div", { children: text.Page.length }, void 0, !1, {
                  fileName: "app/routes/list.tsx",
                  lineNumber: 87,
                  columnNumber: 23
                }, this),
                isAdmin && /* @__PURE__ */ (0, import_jsx_dev_runtime47.jsxDEV)("div", { onClick: () => deleteText2(text.id), className: "cursor-pointer", children: "delete" }, void 0, !1, {
                  fileName: "app/routes/list.tsx",
                  lineNumber: 89,
                  columnNumber: 25
                }, this)
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime47.jsxDEV)("div", { className: "mt-8 flex items-center justify-center", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime47.jsxDEV)(
        "button",
        {
      ...
      Array.from({ length: totalPages }, (_2, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime47.jsxDEV)(
        "button",
        {
...
var assetsBuildDirectory = "public/build", future = { v2_dev: !0, unstable_postcss: !1, unstable_tailwind: !1, v2_errorBoundary: !0, v2_headers: !0, v2_meta: !0, v2_normalizeFormMethod: !0, v2_routeConvention: !0 }, publicPath = "/build/", entry = { module: entry_server_exports }, routes = {
  ...
  "routes/version.$versionId": {
    id: "routes/version.$versionId",
    parentId: "root",
    path: "version/:versionId",
    index: void 0,
    caseSensitive: void 0,
    module: version_versionId_exports
  },
  ...
  "routes/version.create": {
    id: "routes/version.create",
    parentId: "root",
    path: "version/create",
    index: void 0,
    caseSensitive: void 0,
    module: version_create_exports
  },
  "routes/api.reply.$id": {
