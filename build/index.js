...
var globalStyle_default = "/build/_assets/globalStyle-5TEL3SKX.css";

// app/styles/tailwind.css
var tailwind_default = "/build/_assets/tailwind-UZLBAWKZ.css";
...
function copyToClipboard(text) {
  ...
  try {
    document.execCommand("copy"), console.log("Text copied to clipboard");
  } catch (err) {
...
var handleDOMEvents = {
  ...
  paste: (v, event) => {
    event.preventDefault(), console.log(v);
  }
}, noneditable = {
  handleDOMEvents,
  attributes: {
  ...
  return (0, import_react11.useEditor)(
    {
      ...
      onSelectionUpdate: ({ editor: editor2 }) => {
        ...
        }), !editor2.isActive("suggestion") && !editor2.isActive("post") && param.get("with") !== "all" && setSearchParams((p) => (p.set("with", "all"), p.delete("thread"), p));
      }
    },
    condition
  );
...
async function updateSuggestionContent(id, newValue) {
  try {
    return console.log(id), await db.suggestion.update({
      where: {
        id
      },
      data: {
...
function Translations() {
  let { text, page, translations, user } = (0, import_react26.useLoaderData)(), [fileContent, setFileContent] = (0, import_react27.useState)(""), [upload, setUpload] = (0, import_react27.useState)(!1), [title, setTitle] = (0, import_react27.useState)(""), [language, setLanguage] = (0, import_react27.useState)("english"), fetcher = (0, import_react26.useFetcher)(), handleFileUpload = (e) => {
  ...
  return console.log(translations), /* @__PURE__ */ (0, import_jsx_dev_runtime24.jsxDEV)("div", { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime24.jsxDEV)("div", { className: "mt-3", children: [
      ...
      translations?.map((translation, index) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_dev_runtime24.jsxDEV)(import_react26.Link, { to: url, children: /* @__PURE__ */ (0, import_jsx_dev_runtime24.jsxDEV)("div", { className: "flex rounded-lg border border-gray-200 bg-white shadow-md dark:border-gray-700 dark:bg-gray-800 flex-col w-full p-1", children: /* @__PURE__ */ (0, import_jsx_dev_runtime24.jsxDEV)("div", { className: "w-full flex justify-between", children: [
...
async function createPost2(type, avatar, topic_id, post_id, threadId, textId, pageId, content, creatorUser_id, audioUrl, selectionContent) {
  try {
    ...
    throw console.log(e), new Error("post couldnot be created " + e);
  }
}
